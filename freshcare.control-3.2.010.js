...
nsFreshcare.version = '3.2.010';
nsFreshcare.personContext = undefined;
nsFreshcare.businessContext = undefined;
nsFreshcare.supportAdmin = false;
nsFreshcare.sitesDev = '310,313';		// lab "Test", lab "Lab"
nsFreshcare.sitesProd = '1554,1611';	// prod,beta
nsFreshcare.site = '1554';				// prod
nsFreshcare.admin = {};
nsFreshcare.grower = {};
...
nsFreshcare.data.attachmentTypeLogo = '47';			// lab
nsFreshcare.data.attachmentTypeSignature = '48';	// lab
nsFreshcare.data.attachmentTypeCertificate = '49'	// lab
nsFreshcare.data.attachmentTypeEmailImages = '50';	// lab
nsFreshcare.data.actionTypeCertificate = '406';			//lab
nsFreshcare.data.actionTypeLateLoggedAudit = '407';		// lab
nsFreshcare.data.actionTypeAuditRejected = '420';		// lab
nsFreshcare.data.actionTypeEmailSent = '5';
nsFreshcare.data.actionTypeUserNotes = '413';			//lab
nsFreshcare.data.actionTypeLogFile = '428';			//lab
nsFreshcare.data.reportingRoles = ['admin', 'auditor', 'trainer', 'customer'];
nsFreshcare.data.userNameSuffix = 'freshcare';
nsFreshcare.data.growerText = 'Grower';
...
// Structure Id's
nsFreshcare.data.sendPrintedCertificatesId = '2086';	//lab
nsFreshcare.data.userPasswordId = '2105';		// dev
nsFreshcare.data.userSubscriptionStart = '2106';		// lab
nsFreshcare.data.userSubscriptionExpires = '2107';		// lab
nsFreshcare.data.certificationBodyNumberId = '2095';	// lab
nsFreshcare.data.selfCertificationDateId = '2093';		// lab
nsFreshcare.data.jasanzDateId = '2094';					// lab
nsFreshcare.structureElementCrops = '2091';				// lab
nsFreshcare.data.structureMembershipFees = 256;			// lab
...
nsFreshcare.data.audit.resultStatusConducted = '23';		//lab
nsFreshcare.data.audit.resultStatusAwaitingReview = '24';	//lab
nsFreshcare.data.audit.resultStatusApproved = '25';		//lab
nsFreshcare.data.audit.resultStatusRejected = '26';		//lab
...
ns1blankspace.xhtml.logonNotes =
	...
	'Managing Freshcare Accreditation.' +
	'<br /><br /><a style="font-weight:500; color:#80A82B;" target="_blank" href="http://mydigitalstructure.com/terms">By logging on, you are agreeing to the ibcom.biz terms of use</a>';
...
ns1blankspace.themes = 
		[   
			{   title:     'Standard',    
		   		cssURI:    '',     
		   		xhtmlHeaderLogo: '<img src="/site/1554/logo.png" alt="Freshcare" height="45px" width="62px">' 
		    }
		];
...
delete(ns1blankspace.option.messagingCheckURL); // = "https://mail.lab.ibcom.biz"; 		// v3.2.010 removed
...
ns1blankspace.option.preLoad = function()
{
	...
	if (oRoot.site && oRoot.site != msOnDemandSiteId.toString())
	{
		...
		if (ns1blankspace.rootnamespacetext != 'nsFreshcare') 
		{
			...
			{	nsFreshcare.site = '313'; }	// lab site
			else
			{ 	nsFreshcare.site = '1554'}	// prod site
		}
		else
		{
	...
	ns1blankspace.scripts = 
		$.map(ns1blankspace.scripts, function(x)
		{
			...
			if (x.nameSpace === '1blankspace.product') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.product-2.0.3.js';}
...
[
	{	/* Admin */
		...
		[
			...
			{
				title: "New Growers from Trainers",
				namespace: "newgrower",
				parentNamespace: "admin",
				rootnamespace: nsFreshcare,
				...
				search: 
				{
					...
					[
						...
						},
						{
							...
							type: 'Select',
							method: "AGRI_MEMBERSHIP_SEARCH",
							methodFilter: "status-EQUAL_TO-3" ,
							fixed: false
						},
						{
							caption: "Hide Lapsed Audits",
...
[
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.audit-3.2.010.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.auditcar',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.auditcar-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.certificationbody',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.certificationbody-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.certificate',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.certificate-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.customer-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.grower',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.grower-3.2.010.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.home',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.home-3.0.0.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.newtrainee-3.1.208b.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.relationships',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.relationships-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.report',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.report-3.1.215.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.trainer',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.trainer-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.trainingpackage',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.trainingpackage-3.1.215.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.user-3.2.010.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.auditor.grower-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.auditor.home',
		source: '/site/' + nsFreshcare.site + '/freshcare.auditor.home-3.1.207.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.auditor.jasanzexport',
		source: '/site/' + nsFreshcare.site + '/freshcare.auditor.jasanzexport-3.1.212.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.board',
		source: '/site/' + nsFreshcare.site + '/freshcare.board-3.1.2.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.customer.grower',
		source: '/site/' + nsFreshcare.site + '/freshcare.customer.grower-3.2.007.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.customer.home',
		source: '/site/' + nsFreshcare.site + '/freshcare.customer.home-3.1.205.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.external.grower',
		source: '/site/' + nsFreshcare.site + '/freshcare.external.grower-3.2.010.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.extend',
		source: '/site/' + nsFreshcare.site + '/freshcare.extend-3.2.010.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.external.resources',
		source: '/site/' + nsFreshcare.site + '/freshcare.external.resources-3.1.205.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: '1blankspace.grower.audit',
		source: '/site/' + nsFreshcare.site + '/freshcare.grower.audit-3.1.205.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.grower.certificate-3.1.1.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.grower.customer',
		source: '/site/' + nsFreshcare.site + '/freshcare.grower.customer-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.grower.grower',
		source: '/site/' + nsFreshcare.site + '/freshcare.grower.grower-3.2.010.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.grower.home',
		source: '/site/' + nsFreshcare.site + '/freshcare.grower.home-3.1.2.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.grower.trainingcourse',
		source: '/site/' + nsFreshcare.site + '/freshcare.grower.trainingcourse-3.1.1.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.help-3.0.0.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.reviewer.home-3.1.2.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.setup.bulkupdate',
		source: '/site/' + nsFreshcare.site + '/freshcare.setup.bulkupdate-3.1.0e.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.external.freshcareprofile',
		source: '/site/' + nsFreshcare.site + '/freshcare.setup.freshcareprofile-3.2.010.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.setup.membership',
		source: '/site/' + nsFreshcare.site + '/freshcare.setup.membership-3.1.211.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.setup.schemecodes-3.1.0.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.systemadmin-1.0.1.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.trainer.grower',
		source: '/site/' + nsFreshcare.site + '/freshcare.trainer.grower-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.trainer.home',
		source: '/site/' + nsFreshcare.site + '/freshcare.trainer.home-3.1.207.js',
		sourceNS: nsFreshcare
	}
]
...
nsFreshcare.doLast = function() 
{
	...
	if (ns1blankspace.format && ns1blankspace.format.tags)
	{
		...
		if ($.grep(ns1blankspace.format.tags, function(x) {return x.caption === 'Mailing Suburb'}).length === 0)
		{
...
nsFreshcare.app = 
{
	...
	bindClasses: function()
	{
		...
		$('input.nsFreshcareSelectGrower').live('focusout', function() 
		{	
			$(this).removeClass('ns1blankspaceHighlight');
		});

		$('input.nsFreshcareSelectGrower').live('focusin', function() 
		{		
		...
		$('input.nsFreshcareSelectGrower').live('keyup', function(e)
		{
			var oEvent = e;
			var oElement = this;
			nsFreshcare.util.businessPersonSelection(oEvent, oElement);		// Added same funcitonality as ns1blankspaceSelect

			// v3.1.1 SUP022419 Removed action onEnter as was causing entire list to appear
			//if (e.which === 13)
	    	//{
			//	nsFreshcare.util.searchGrower.show({xhtmlElementID: ns1blankspace.xhtml.divID, source: 4});
			//}
	...
	initCommonVariables: 	function() 
	{
		...
		if (nsFreshcare.sitesDev.indexOf(nsFreshcare.site) > -1) 
		{
			...
			nsFreshcare.data.documentCertificateBackground = '6229';		
		...
		else 
		{
			...
			nsFreshcare.data.actionTypeLogFile = '1548';
			...
			// Old documents v1.0.??
			nsFreshcare.data.legacyCertificate.documentCertificateText = '54416';		
			nsFreshcare.data.legacyCertificate.documentCertificateBackgroundFSQ = '54415';		
			nsFreshcare.data.legacyCertificate.documentCertificateBackgroundOther = '54439';	
			nsFreshcare.data.currentCertificate.documentCertificateText = '55647';		
			nsFreshcare.data.currentCertificate.documentCertificateBackgroundFSQ = '55645';		
			nsFreshcare.data.currentCertificate.documentCertificateBackgroundOther = '55646';	

			// New documents v2.0.1
			// Beta site
			nsFreshcare.data.legacyCertificate.documentCertificateBackground = '56171';		
			nsFreshcare.data.documentCertificateBackground = '71185';		
			...
			//nsFreshcare.data.currentCertificate.documentCertificateTextFSQ = '58227';		
			nsFreshcare.data.currentCertificate.documentCertificateTextFSQ = '71204';		
			//nsFreshcare.data.currentCertificate.documentCertificateTextOther = '58228';		
			...
			nsFreshcare.data.audit.requiredAttachmentTypes = 
			[
				/*{type: nsFreshcare.data.attachmentTypeAuditReport, typetext: 'Audit Report', fileExtension: 'pdf', resultStatus: nsFreshcare.data.audit.resultStatusAwaitingReview},
				{type: '351', typetext: 'Internal Document', fileExtension: 'pdf,doc,docx,xls,xlsx', resultStatus: nsFreshcare.data.audit.resultStatusApproved}*/
				{type: nsFreshcare.data.attachmentTypeAuditReport, typetext: 'Audit Report', fileExtension: 'pdf', resultStatus: nsFreshcare.data.audit.resultStatusPending},
				{type: nsFreshcare.data.attachmentTypeAuditReport, typetext: 'Audit Report', fileExtension: 'pdf', resultStatus: nsFreshcare.data.audit.resultStatusCompleted},
			...
			delete(ns1blankspace.option.messagingCheckURL);// = "https://api.mydigitalstructure.com/"; 		// v3.2.010 removed
		}
...
nsFreshcare.control = 
{
	...
	init: 		function(oParam) 
	{
		...
		if (oParam.controlInitStep === 0) 
		{
			...
			if ((oRootNamespace.site.toString()).indexOf(oRootNamespace.sitesDev) === -1) 
			{
			...
			if (ns1blankspace.user.roles) 
			{
				...
				else 
				{
					...
					{
						var sHeaderText = (nsFreshcare.user.role == "Auditor") 
							 	? "Certification Bodie" 
								: ((nsFreshcare.user.role.toLowerCase() != 'grower') ? nsFreshcare.user.role : nsFreshcare.data.growerText);
						
						$('#nsFreshcareOnlineHeaderRole').html(nsFreshcare.data.appName + ' for ' + sHeaderText + (nsFreshcare.user.role.toLowerCase() == 'jasanz' ? '' : 's'));		
					...
					ns1blankspace.report.showUpdate = (nsFreshcare.user.role.toLowerCase() === 'admin');
					ns1blankspace.report.showEmail = (nsFreshcare.user.role.toLowerCase() === 'admin');
					ns1blankspace.report.showSMS = (nsFreshcare.user.role.toLowerCase() === 'admin');
				}
			}
			else 
			{
				...
				{	
						...
						|| nsFreshcare.util.anyMatchInArray($.map(ns1blankspace.user.roles, function(x) {return x.id}), nsFreshcare.util.getRoles({roleNames: this.roles}).split(',')))
					{
						if (this.namespace == "audit" && this.parentNamespace == "admin") 
						{
							...
							else if (nsFreshcare.user.role.toLowerCase() === 'admin' || nsFreshcare.user.role.toLowerCase() === 'internal auditor')
							{
								...
								this.search.filters.unshift(							
								{
									...
									method: "CONTACT_BUSINESS_SEARCH",
									methodFilter: "tradename-TEXT_IS_LIKE|legalname-TEXT_IS_LIKE|" +
												  "contactbusiness.businessgroup-EQUAL_TO-" + nsFreshcare.data.groupAuditor.join('') + '|' + 
		...
		{
			// v3.1.1e SUP022638 Now applies also to internal auditor
			if (nsFreshcare.user.role.toLowerCase() === "admin" || nsFreshcare.user.role.toLowerCase() === 'internal auditor' || nsFreshcare.user.role.toLowerCase() == 'jasanz') 
			{
				...
				// v3.2.004 SUP023223 No longer require this check
				/*else if (nsFreshcare.user.emailSignature === undefined)
				{
					oParam = ns1blankspace.util.setParam(oParam, 'onComplete', nsFreshcare.control.init);
					nsFreshcare.control.getEmailSignature(oParam);
				}*/
			...
			else if (nsFreshcare.user.role.toLowerCase() === "grower") 
			{
			...
			else if (nsFreshcare.user.role.toLowerCase() === "customer") 
			{
			...
			else if (nsFreshcare.user.role.toLowerCase() === "auditor") 
			{
			...
			else if (nsFreshcare.user.role.toLowerCase() === "board member") 
			{
			...
			else if (nsFreshcare.user.role.toLowerCase() === "reviewer")
			{
	...
	home: 		
	{
		...
		show: 	function() 
		{
			...
			aHTML.push('<td id="ns1blankspaceHomeColumn1" class="ns1blankspaceColumn1Flexible">' + ns1blankspace.xhtml.loading + '</td>');
	...
	freshcareMemberships: 	function(oParam, oResponse) 
	{
		...
		if (oParam == undefined) {
			oParam = {freshcareMembershipsStep: 1}
		}
		else if (oParam.freshcareMembershipsStep === undefined) {
			oParam.freshcareMembershipsStep = 1;
		}
		...
		if (oParam.freshcareMembershipsStep === 1) 
		{
			if (oResponse === undefined) {
				...
				oSearch.addField('code,description,reference,title,jasanzaccredited');
			...
			else 
			{
				if (oResponse.status === 'OK') 
				{
					...
					nsFreshcare.data.membershipFSQ = $.map(
													   $.grep(oResponse.data.rows, function(x) {
	...
	getScopeOptions: function(oParam)
	{
		...
		oSearch.getResults(function(oResponse)
		{
			if (oResponse.status == 'OK')
			{
				...
				// v3.1.0 For Freshcare internal upgrade whilst in changeover, we need to map scopes to businessgroups for new grower from trainers
				// REMOVE WHEN CHANGEOVER COMPLETE. Removed v3.1.204
				/*if (ns1blankspace.rootnamespacetext === 'nsFreshcare')
				{
					$.each(nsFreshcare.data.scopeOptions, function()
					{
						var oThisScope = this;
						this.group = $.grep(nsFreshcare.data.businessGroupGrowerText, function(x) {return x.title === oThisScope.title}).shift().id;
						this.grouptext = this.title;
					});
				}*/
	...
	{	// Added v3.1.2 SUP022543
		...
		nsFreshcare.data.resultStatusOptions.push({index: nsFreshcare.data.resultStatusOptions.length, id: nsFreshcare.data.audit.resultStatusConducted, title: 'Conducted',
												validOptions: 
												[
													nsFreshcare.data.audit.resultStatusNoResult,
	...
	getCertificationBodyOptions: function(oParam)
	{
		...
		if (oParam)
		{
			...
			{
				oParam.cbOptionsStep = (nsFreshcare.data.selfCertificationDateId && nsFreshcare.data.jasanzDateId) ? 1 : 2;
			}
		}
		...
		if (oParam.cbOptionsStep === 1)
		{
			...
			oSearch.addField('se' + nsFreshcare.data.selfCertificationDateId + ',se' + nsFreshcare.data.jasanzDateId + ',semanualauditapproval');
			...
			oSearch.getResults(function(oResponse)
			{
				if (oResponse.status === 'OK' && oResponse.data.rows.length > 0)
				{
					...
					nsFreshcare.data.auditor.jasanzDate = oResponse.data.rows[0]['se' + nsFreshcare.data.jasanzDateId];
					nsFreshcare.data.auditor.manualAuditApproval = oResponse.data.rows[0].semanualauditapproval;
					oParam.cbOptionsStep = 3;
					nsFreshcare.control.getCertificationBodyOptions(oParam);
				}
	...
	getEmailSignature: function(oParam)
	{

		if (oParam)
		{
			if (oParam.getEmailSignatureStep === undefined) {oParam.getEmailSignatureStep = 1}
		}
		else {oParam = {getEmailSignatureStep: 1}}

		if (oParam.getEmailSignatureStep === 1)
		{
			var oSearch = new AdvancedSearch();
			oSearch.method = 'SETUP_MESSAGING_ACCOUNT_SEARCH';
			oSearch.addField('footer');
			...
			oSearch.getResults(function(oResponse)
			{
				if (oResponse.status === 'OK')
				{
					if (oResponse.data.rows.length > 0 && oResponse.data.rows[0].footer != '')
					{	
						nsFreshcare.user.emailSignature = oResponse.data.rows[0].footer;
						oParam.getEmailSignatureStep = 3;
					}
					else
					{
						// Try against the contactPerson record
						oParam.getEmailSignatureStep = 2;
						nsFreshcare.user.emailSignature = undefined;
					}
				}
				else
				{
					...
					if (nsFreshcare.sitesDev.indexOf(nsFreshcare.site) == -1)
					{
						if ($('#ns1blankspaceViewControlActionStatus').is('*'))
						{	
							ns1blankspace.status.error('Error getting email signature: ' + oResponse.error.errornotes);
						}
						else
						{
							alert('Error getting email signature: ' + oResponse.error.errornotes);
						}
					}
				}
				nsFreshcare.control.getEmailSignature(oParam);
		...
		else if (oParam.getEmailSignatureStep === 2)
		{
			// Try looking on the contactPerson record
			var oSearch = new AdvancedSearch();
			...
			oSearch.getResults(function(oResponse)
			{
				nsFreshcare.user.emailSignature = '';
				if (oResponse.status === 'OK')
				{
					if (oResponse.data.rows.length > 0 && oResponse.data.rows[0].signature != '')
					{	
						nsFreshcare.user.emailSignature = oResponse.data.rows[0].signature;
						ns1blankspace.user.emailSignature = oResponse.data.rows[0].signature;
					}
					else
					{
						// v2.0.3h if element isn't yet defined, app doesn't load
						if (nsFreshcare.sitesDev.indexOf(nsFreshcare.site) == -1)
						{
							if ($('#ns1blankspaceViewControlActionStatus').is('*'))
							{	
								ns1blankspace.status.error('No email signature found. Please set this up via ' +
													((nsFreshcare.user.role.toLowerCase() === 'admin') ? 'Email setup' : 'Freshcare Profile'));
							}
							else
							{
								alert('No email signature found. Please set this up via ' +
													((nsFreshcare.user.role.toLowerCase() === 'admin') ? 'Email setup' : 'Freshcare Profile'));
							}
						}
					}
		...
		// Call back onComplete
		else if (oParam.getEmailSignatureStep === 3)
		{
			delete(oParam.getEmailSignatureStep);
	...
	views:
	{
		show: function()
		{
			if (ns1blankspace.xhtml.viewControl == undefined)
			{
				...
				if ($.grep(nsFreshcare.data.reportingRoles, function(x) {return x === nsFreshcare.user.role.toLowerCase()}).length > 0)
				{
					aHTML.push('<td class="ns1blankspaceViewControl" colspan=' + ns1blankspace.viewGroups.length + 
									...
									((nsFreshcare.user.role.toLowerCase() === 'admin') ? 'Search... report, export, update, email and SMS' : 'Search & Reporting...') +
									'</span></td>');
								aHTML.push('</tr></table>');
				}
	...
	setView: 
	{
		"default": 	function ()
		{
			...
			else if (nsFreshcare.user.role == "Grower") {
				nsFreshcare.grower.certificate.init({showHome: true});
			}
			else if (nsFreshcare.user.role == "Customer") {
				nsFreshcare.customer.grower.init({showHome: true});
			}
			else if (nsFreshcare.user.role == "Auditor") {
				nsFreshcare.auditor.grower.init({showHome: true});
			}
			else if (nsFreshcare.user.role == "Trainer") {
				nsFreshcare.trainer.grower.init({showHome: true});
			}
			else if (nsFreshcare.user.role == "Board Member") {
		...
		setup:	function ()
		{
			if (nsFreshcare.user.role.toLowerCase() != 'admin' && ns1blankspace.util.toFunction('nsFreshcare.setup.freshcareprofile.init') !== undefined)
			{	
				nsFreshcare.setup.freshcareprofile.init();
			}
			else if (nsFreshcare.user.role.toLowerCase() === 'admin' && ns1blankspace.util.toFunction('nsFreshcare.admin.user.init') !== undefined)
			{
...
{		// Added v1.022 - change 'get it' to 'forgotten'
	...
	aHTML.push('<tr><td class="ns1blankspaceLogonSub" colspan="2" style="text-align: left;padding-top:5px;">' +
					'remember <input style="margin:0px; padding-top:5px; border: 0px;" type="checkbox" id="ns1blankspaceLogonRemember"/></td></tr>');
