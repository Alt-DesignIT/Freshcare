				...
				{							
					...
					if (sSearchText.length >= iMinimumLength || iSource === ns1blankspace.data.searchSource.all || bCache)
					{
						...
						if (ns1blankspace.util.isMethodAdvancedSearch(sMethod))
						{
							...
							{
								if (this != 'space' && this != 'comma' && this != 'pipe' && this != 'openbracket' && this != 'closebracket')
								{	
							...
							{	
								...
								{
									if (this != 'space' && this != 'comma' && this != 'pipe' && this != 'column' && this != 'openbracket' && this != 'closebracket')
									{	
										if (i != 0)
										{
		...
		if (sBusinessID != undefined && $('#' + sXHTMLPersonID).val() === '') {
			...
			oSearch.getResults(function(oResponse) {
				...
				if (oResponse.status === 'OK') {
					...
					if (oRow['contactbusiness.contactperson.firstname'] + oRow['contactbusiness.contactperson.surname'] != '') {
						
						// v3.1.1 Added data-person and data-surname attributes
						// Populate person field
						$('#' + sXHTMLPersonID).val(oRow['contactbusiness.contactperson.firstname'].formatXHTML() + ' ' + oRow['contactbusiness.contactperson.surname'].formatXHTML());
						$('#' + sXHTMLPersonID).attr('data-firstname', oRow['contactbusiness.contactperson.firstname'].formatXHTML());
						$('#' + sXHTMLPersonID).attr('data-surname', oRow['contactbusiness.contactperson.surname'].formatXHTML());
						$('#' + sXHTMLPersonID).attr('data-id', oRow['contactbusiness.contactperson.id']);
