		...
		people:
		{
			...
			newPage: function(oParam)
			{
				...
				else if (oParam.newPageStep == 3)
				{
					...
					if (oParam.pageObject == 'trainer' && nsFreshcare.user.roleLower == 'admin')
					{
				...
				send: function(oParam)
				{
					...
					if (sID && sXHTMLElementID)
					{
						...
						else if (oParam.savePrimaryContactStep === 3)
						{
							...
							if (nsFreshcare.user.roleLower === 'auditor' || nsFreshcare.user.roleLower === 'grower' || nsFreshcare.user.roleLower === 'trainer')
							{
								$.extend(oParam, false,
								{
									to: nsFreshcare.data.emailToAdmin,
									from: nsFreshcare.data['emailFrom' + nsFreshcare.user.role],
									replyTo: (nsFreshcare.user.role == nsFreshcare.data.roles.auditor ? ns1blankspace.user.contactPerson : undefined),
