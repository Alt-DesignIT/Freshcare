		...
		invoice:
		{
			...
			commissions: 	
			{
				...
				calculateLineItemAmount: function(oRow)
				{
					...
					var iFeeTypeSecondary = ns1blankspace.util.getParam(oRow, 'feeType', {'default': '3'}).value;
	...
	contactBusiness:
	{
		...
		layout: function()
		{
			...
			else
			{
				...
				if (nsFreshcare.util.roleHasAccess({tabs: ['Groups', 'Relationships'], access: oRoot.internal.contactBusiness.access()}))
				{
