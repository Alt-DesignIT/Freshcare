		...
		search: function(oParam) 
		{
			...
			else if (oParam.certificatesToSendStep === 1)
			{
				...
				else if (sEmailFilter === '3')
				{
					...
					oSearch.addFilter('audit.contactperson.email', 'TEXT_IS_LIKE', '@');
					oSearch.addFilter('audit.contactperson.email', 'TEXT_IS_LIKE', '.');
					oSearch.addFilter('audit.contactbusiness.se' + nsFreshcare.data.sendPrintedCertificatesId + 'text', 'EQUAL_TO', 'Yes');
				}
		...
		process: function(oParam)
		{
			...
			else
			{
				...
				if (iSendOperation != '1' && !bUpdateSentFlagOnly && !bPreview)
				{
					...
					ns1blankspace.report.init({all:false});		// V3.1.203 SUP022991 Moved to above replaces below
					...
					ns1blankspace.objectMethod = 'AGRI_CERTIFICATE_SEARCH';		// V3.1.203 SUP022991 Added _SEARCH
					ns1blankspace.report.reports.passedData.certificateid;
					$.each(ns1blankspace.report.reports, function()
					{
						if (this.method === ns1blankspace.objectMethod)
						{
				...
				else if (sOutputOption === '3')		
				{
					...
					else
					{
						...
						else
						{
							...
							oParam.name = 'Export Certificate Data';
							oParam.items = oItems;
