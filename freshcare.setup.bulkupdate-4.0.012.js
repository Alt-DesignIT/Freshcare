...
nsFreshcare.setup.bulkupdate = 
{
	...
	show: 	function (oParam) 
	{
		...
		aHTML.push('<tr class="ns1blankspaceControl">' +
						'<td id="ns1blankspaceControlUpdateGrowerDetails" class="ns1blankspaceControl ns1blankspaceControlHome">' +
							'Update ' + nsFreshcare.data.growerText + ' Details</td>' +
						'</tr>');
		aHTML.push('<tr class="ns1blankspaceControl" style="height=100px;"><td>&nbsp;</td></tr>');
		...
		*/
		aHTML.push('<tr class="ns1blankspaceControl">' +
						'<td id="ns1blankspaceControlcreateAttendanceLinks" class="ns1blankspaceControl ns1blankspaceControlHome">' +
							'Create Attendance Links</td>' +
						'</tr>');
		
		aHTML.push('<tr class="ns1blankspaceControl">' +
						'<td id="ns1blankspaceControlPopulateAuditQualifyingTrainee" class="ns1blankspaceControl ns1blankspaceControlHome">' +
							'Populate Qualifying Trainee</td>' +
						'</tr>');

		aHTML.push('<tr class="ns1blankspaceControl">' +
						'<td id="ns1blankspaceControlPopulateAuditReCertAuditMonth" class="ns1blankspaceControl ns1blankspaceControlHome">' +
							'Populate Re-Cert Audit Month</td>' +
						'</tr>');

		aHTML.push('<tr class="ns1blankspaceControl">' +
						'<td id="ns1blankspaceControlPopulateJASANZAudit" class="ns1blankspaceControl ns1blankspaceControlHome">' +
							'Populate JASANZ Audit Flag</td>' +
						'</tr>');

		aHTML.push('<tr class="ns1blankspaceControl">' +
						'<td id="ns1blankspaceControlPopulateLinkRequests" class="ns1blankspaceControl ns1blankspaceControlHome">' +
							'Populate Allow Link Requests flag</td>' +
						'</tr>');

		aHTML.push('<tr class="ns1blankspaceControl">' +
						'<td id="ns1blankspaceControlPopulateCARTypePrefix" class="ns1blankspaceControl ns1blankspaceControlHome">' +
							'Populate CAR Type Prefix</td>' +
						'</tr>');

		aHTML.push('<tr class="ns1blankspaceControl">' +
						'<td id="ns1blankspaceControlPopulateActionBusiness" class="ns1blankspaceControl ns1blankspaceControlHome">' +
							'Populate Action Business</td>' +
						'</tr>');

		aHTML.push('<tr class="ns1blankspaceControl">' +
						'<td id="ns1blankspaceControlRemoveInvalidScopes" class="ns1blankspaceControl ns1blankspaceControlHome">' +
							'Remove Invalid Scopes</td>' +
						'</tr>');
	...
	bind: 	function ()
	{
		...
		*/
		$('#ns1blankspaceControlcreateAttendanceLinks').click(function(event)
		{
			...
			nsFreshcare.setup.bulkupdate.data.userContinue = 2;
			oParam = nsFreshcare.setup.bulkupdate.createAttendanceLinks.setParams(oParam);
			nsFreshcare.setup.bulkupdate.showUpdate(oParam);
		});
		
		$('#ns1blankspaceControlPopulateAuditQualifyingTrainee').click(function(event)
		{
			...
			nsFreshcare.setup.bulkupdate.data.userContinue = 2;
			oParam = nsFreshcare.setup.bulkupdate.populateAuditQualifyingTrainee.setParams(oParam);
			nsFreshcare.setup.bulkupdate.showUpdate(oParam);
		});

		$('#ns1blankspaceControlPopulateAuditReCertAuditMonth').click(function(event)
		{
			...
			nsFreshcare.setup.bulkupdate.data.userContinue = 2;
			oParam = nsFreshcare.setup.bulkupdate.populateAuditRecertAuditMonth.setParams(oParam);
			nsFreshcare.setup.bulkupdate.showUpdate(oParam);
		});

		$('#ns1blankspaceControlPopulateJASANZAudit').click(function(event)
		{
			...
			nsFreshcare.setup.bulkupdate.data.userContinue = 2;
			oParam = nsFreshcare.setup.bulkupdate.populateJASANZAuditFlag.setParams(oParam);
			nsFreshcare.setup.bulkupdate.showUpdate(oParam);
		});

		$('#ns1blankspaceControlPopulateLinkRequests').click(function(event)
		{
			...
			nsFreshcare.setup.bulkupdate.data.userContinue = 2;
			oParam = nsFreshcare.setup.bulkupdate.populateLinkRequests.setParams(oParam);
			nsFreshcare.setup.bulkupdate.showUpdate(oParam);
		});

		$('#ns1blankspaceControlPopulateCARTypePrefix').click(function(event)
		{
			...
			nsFreshcare.setup.bulkupdate.data.userContinue = 2;
			oParam = nsFreshcare.setup.bulkupdate.populateCARTypePrefix.setParams(oParam);
			nsFreshcare.setup.bulkupdate.showUpdate(oParam);
		});
		
		$('#ns1blankspaceControlPopulateActionBusiness').click(function(event)
		{
			...
			nsFreshcare.setup.bulkupdate.data.userContinue = 2;
			oParam = nsFreshcare.setup.bulkupdate.populateActionBusiness.setParams(oParam);
			nsFreshcare.setup.bulkupdate.showUpdate(oParam);
		});
		
		$('#ns1blankspaceControlRemoveInvalidScopes').click(function(event)
		{
			...
			nsFreshcare.setup.bulkupdate.data.userContinue = 2;
			oParam = nsFreshcare.setup.bulkupdate.removeInvalidScopes.setParams(oParam);
			nsFreshcare.setup.bulkupdate.showUpdate(oParam);
		});
	},
			...
			else if (oParam.searchStep === 2)
			{
				...
				$.ajax(
				{
					...
					success: function(oResponse)
					{
						...
						{
							$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('');		
							aHTML = ['<tr><td>Error searching for ' + nsFreshcare.data.growersText + ': ' + oResponse.error.errornotes + '</td></tr>'];
							$('#' + oParam.progressTableId).children().children().last().after(aHTML.join(''));
						}
					}
				});
	...
	updateCertificatePrintOption: 
	{
		...
		search: function(oParam)
		{
			...
			var iStartRow;
			var iRows;
			var bNullAudit = (ns1blankspace.isLab) ? false : true ;
			var aHTML = [];
			var iTotal = 0;
			...
			{
				// First add the progress bar
				aHTML.push('<tr><td>Finding and updating ' + nsFreshcare.data.growersText + '</td>' +
				...
				oSearch.getResults(function(oResponse)
				{
					...
					if (oResponse.status === 'OK')
					{
						...
						else
						{
							...
							aHTML = ['<tr><td>No ' + nsFreshcare.data.growersText + ' to update</td></tr>'];
							$('#' + oParam.progressTableId).children().children().last().after(aHTML.join(''));
		...
		update: function(oParam)
		{
			...
			{
				$('#ns1blankspaceBulkUpdateCertificatePrintOptionProgressBar').html('No ' + nsFreshcare.data.growersText + ' found');
			}
					...
					if (bPerformUpdate)
					{
						$.ajax(
						{
							...
							success: function(oResponse)
							{
								if (oResponse.status === 'OK')
								{
									aHTML.push('<tr><td>' + nsFreshcare.data.growerText + ' updated: ' + sContactBusinessText + '</td></tr>');
									$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
								}
								else
								{
	...
	removeDuplicateProductGroups: 
	{
		...
		show: 	function(oParam)
		{
			...
			aHTML.push('<tr><td class="ns1blankspaceColumn1Flexible ns1blankspaceCaption">Remove Duplicate Product Categories</td>' +
						'<td style="width:170px;">&nbsp;</td></tr>' +
						'<tr><td class="ns1blankspaceSummary">' +
						'Removes duplicated Product Groups (Categories) from ' + nsFreshcare.data.growersText + '.' +
						'</td>' +
		...
		update: function(oParam)
		{
			...
			{
				$('#ns1blankspaceBulkUpdateDuplicateProductGroupsProgressBar').html('No ' + nsFreshcare.data.growersText + ' found');
			}
	...
	updateGrowerDetails: 
	{
		...
		update: function(oParam)
		{
			...
			else
			{
				...
				{
					$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('No ' + nsFreshcare.data.growersText + ' found');
				}
	...
	createAttendanceLinks:
	{
		/* Create Attendance links to Person, Business & Membership */
		setParams: function(oParam)
		{
			if (oParam === undefined) {oParam = {}}

			oParam.xhtmlContext = 'AttendanceLinks';
			oParam.title = 'Populate Attendance Links table';
			oParam.description = 'Initial population of Attendance Links table';
			oParam.search = {};
			oParam.search.method = 'AGRI_EDUCATION_TRAINING_COURSE_ATTENDEE_SEARCH';
			oParam.search.fields = 'traineecontactbusiness,traineecontactperson,traineecontactbusinesstext,traineecontactpersontext,' +
									'attendingtrainee,firstname,surname,agritrainingcourseattendee.course.reference,' +
									'agritrainingcourseattendee.traineecontactbusiness.agrisubscription.id,agritrainingcourseattendee.course.coursedate,' +
									'agritrainingcourseattendee.course.trainercontactbusinesstext,agritrainingcourseattendee.course.coursedate,' +
									'agritrainingcourseattendee.course.package.membership,agritrainingcourseattendee.traineecontactbusiness.agrisubscription.membership,' +
									'agritrainingcourseattendee.course.package.membership.code,agritrainingcourseattendee.course.package.codeofpracticetext';
			oParam.search.filters = 
			[
				{field: 'agritrainingcourseattendee.traineecontactbusiness.agrisubscription.membership', comparison: 'EQUAL_TO', value1: 'field:agritrainingcourseattendee.course.package.membership'}
			];
			oParam.search.sortFields = 
			[
				{field: 'traineecontactbusinesstext', direction: 'asc'},
				{field: 'traineecontactpersontext', direction: 'asc'}
			];
			oParam.functionUpdate = nsFreshcare.setup.bulkupdate.createAttendanceLinks.update;
		...
		update: function(oParam)
		{
			// Step 1 - If no TraineeContactPerson or if TraineeContactPerson is null, search for primary contact and update
			// Step 2 - If no AttendingTrainee or Firstname / Surname, udpate with primary contact
			// Step 3 - Search to see if link exists already
			// Step 4 - create link if doesn't exist
			oParam = oParam || {};
			var oData = ns1blankspace.util.getParam(oParam, 'data').value;
			var iRowCount = ns1blankspace.util.getParam(oParam, 'startRow', {'default': 0}).value;
			var iTotal = ns1blankspace.util.getParam(oParam, 'totalCount', {'default': 0}).value;
			var sProgressTableId = ns1blankspace.util.getParam(oParam, 'progressTableId').value;
			var aHTML = [];
			var iPercentage = 0;
			var bPerformUpdate = true;
			var iDataIndex = ns1blankspace.util.getParam(oParam, 'dataIndex', {'default': -1}).value;
			var sXHTMLContext = ns1blankspace.util.getParam(oParam, 'xhtmlContext').value;
			var fFunctionUpdate = ns1blankspace.util.getParam(oParam, 'functionUpdate').value;

			oParam.createAttendanceStep = oParam.createAttendanceStep || 1;
			...
			else
			{
				if (iDataIndex === -1 && oData.length > 0)
				{
					if (oParam.startRow === 1)
					{	$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('');	}
					nsFreshcare.setup.bulkupdate.data.attendeeData = oData;
					iDataIndex = 0;
					oParam.dataIndex = 0;
					oParam.updateStep = 1;
				}
				...
				if (iDataIndex < nsFreshcare.setup.bulkupdate.data.attendeeData.length)
				{
					...
					var sContactBusinessText = oThisRow['traineecontactbusinesstext'].formatXHTML() + ' | ' +
												oThisRow['agritrainingcourseattendee.course.reference'] + ' | ' +
												oThisRow['agritrainingcourseattendee.course.coursedate'] + '|' + 
												oThisRow['agritrainingcourseattendee.course.package.membership.code'] + ' ' + oThisRow['agritrainingcourseattendee.course.package.codeofpracticetext'];

					// First, if contactperson is invalid and set to Member's primary contact 
					if (oParam.createAttendanceStep == 1)
					{
						oParam.createAttendanceStep = 2;
						if (oThisRow.traineecontactpersontext == '' || oThisRow.traineecontactperson == '')
						{	// We need to get a valid contactperson
							var oPersonSearch = new AdvancedSearch();
							oPersonSearch.method = 'CONTACT_PERSON_SEARCH';
							oPersonSearch.addField('firstname,surname,contactbusiness,contactbusinesstext');
							oPersonSearch.addFilter('contactbusiness', 'EQUAL_TO', oThisRow.traineecontactbusiness);
							oPersonSearch.addFilter('contactperson.contactbusiness.primarycontactperson', 'EQUAL_TO', 'field:id');
							oPersonSearch.getResults(function(oResponse)
							{
								aHTML.push('<tr><td>' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + ' | Training does not have a ' + 
												'valid contactperson | ');
								if (oResponse.status == 'OK' && oResponse.data.rows.length > 0)
								{
									var oAttendanceData = 
									{
										id: oThisRow.id,
										traineecontactperson: oResponse.data.rows[0].id
									}
									oAttendanceData.attendingtrainee = ((oThisRow.attendingtrainee == '') 
																		? oResponse.data.rows[0].firstname.formatXHTML() + ' ' + oResponse.data.rows[0].surname.formatXHTML()
																		: oThisRow.attendingtrainee).formatXHTML();
									oAttendanceData.firstname = ((oThisRow.firstname == '') ? oResponse.data.rows[0].firstname : oThisRow.firstname).formatXHTML();
									oAttendanceData.surname = ((oThisRow.surname == '') ? oResponse.data.rows[0].surname : oThisRow.surname).formatXHTML();

									$.ajax(
									{
										type: 'POST',
										url: ns1blankspace.util.endpointURI('AGRI_EDUCATION_TRAINING_COURSE_ATTENDEE_MANAGE'),
										data: oAttendanceData,
										success: function(oUpdateResponse)
										{
											if (oUpdateResponse.status == 'OK')
											{
												aHTML.push('Set to primary contact: ' + oResponse.data.rows[0].firstname.formatXHTML() + ' ' + oResponse.data.rows[0].surname.formatXHTML() +
																'</td></tr>');
												oThisRow.traineecontactperson = oResponse.data.rows[0].id;
												oThisRow.traineecontactpersontext = oResponse.data.rows[0].surname + ', ' + oResponse.data.rows[0].firstname;
												oThisRow.attendingtrainee = oResponse.data.rows[0].firstname.formatXHTML() + ' ' + oResponse.data.rows[0].surname.formatXHTML();
												oThisRow.firstname = oResponse.data.rows[0].firstname;
												oThisRow.surname = oResponse.data.rows[0].surname;
											}
											else
											{
												aHTML.push('Error setting primary contact | id: ' + oThisRow.id + ' : ' + oUpdateResponse.error.errornotes + '</td></tr>');
												oParam.dataIndex += 1;
												oParam.createAttendanceStep = 1;
											}
								...
								else
								{
									if (oResponse.status == 'ER')
									{
										aHTML.push('Error finding primary contact | id: ' + oThisRow.id + ' : ' + oResponse.error.errornotes);
									}
									else
									{
										aHTML.push('Error: Cannot find primary contact | id: ' + oThisRow.id + '');
									}
									oParam.createAttendanceStep = 1;
									oParam.dataIndex += 1;
									aHTML.push('</td></tr>');
					...
					// If attendingtrainee. firstname or surname are blank, update with primary contact value
					else if (oParam.createAttendanceStep == 2)
					{
						oParam.createAttendanceStep = 3;
						if (oThisRow.traineecontactperson != '' &&
							(oThisRow.attendingtrainee == '' || oThisRow.firstname == '' || oThisRow.surname == ''))
						{
							var oPersonSearch = new AdvancedSearch();
							oPersonSearch.method = 'CONTACT_PERSON_SEARCH';
							oPersonSearch.addField('firstname,surname,contactbusiness,contactbusinesstext');
							oPersonSearch.addFilter('id', 'EQUAL_TO', oThisRow.traineecontactperson);
							oPersonSearch.getResults(function(oResponse)
							{
								aHTML.push('<tr><td>' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + ' | Training is missing attendingtrainee | ');
								if (oResponse.status == 'OK' && oResponse.data.rows.length > 0)
								{
									var oAttendanceData = {id: oThisRow.id};
									var sMessageText = '';

									if (oThisRow.attendingtrainee != '')
									{
										oAttendanceData.attendingtrainee = oThisRow.attendingtrainee.formatXHTML();
										oAttendanceData.firstname = ((oThisRow.attendingtrainee.indexOf(',') > -1) 
																		? oThisRow.attendingtrainee.split(',').pop()
																		: oThisRow.attendingtrainee.split(' ').shift()).formatXHTML();
										oAttendanceData.surname = ((oThisRow.attendingtrainee.indexOf(',') > -1) 
																		? oThisRow.attendingtrainee.split(',').shift()
																		: oThisRow.attendingtrainee.split(' ').pop()).formatXHTML();
										sMessageText = 'Attending Trainee';
									}
									else if (oThisRow.firstname != '' && oThisRow.surname != '')
									{
										oAttendanceData.attendingtrainee = oThisRow.firstname.formatXHTML() + ' ' + oThisRow.surname.formatXHTML()
										oAttendanceData.firstname = oThisRow.firstname.formatXHTML();
										oAttendanceData.surname = oThisRow.surname.formatXHTML();
										sMessageText = 'Firstname & Surname';
									}
									else
									{
										oAttendanceData.attendingtrainee = oResponse.data.rows[0].firstname.formatXHTML() + ' ' + oResponse.data.rows[0].surname.formatXHTML();
										oAttendanceData.firstname = oResponse.data.rows[0].firstname.formatXHTML();
										oAttendanceData.surname = oResponse.data.rows[0].surname.formatXHTML();
										sMessageText = 'Contact person';
									}
									...
									$.ajax(
									{
										...
										success: function(oUpdateResponse)
										{
											if (oUpdateResponse.status == 'OK')
											{
												aHTML.push('Set to ' + sMessageText + '</td></tr>');
												oThisRow.attendingtrainee = oAttendanceData.attendingtrainee;
												oThisRow.firstname = oAttendanceData.firstname;
												oThisRow.surname = oAttendanceData.surname;
											}
											else
											{
												aHTML.push('Error setting attending trainee | id: ' + oThisRow.id + ' : ' + oUpdateResponse.error.errornotes + '</td></tr>');
												oParam.dataIndex += 1;
												oParam.createAttendanceStep = 1;
											}
								...
								else
								{
									if (oResponse.status == 'ER')
									{
										aHTML.push('Error finding contact | id: ' + oThisRow.id + ' : ' + oResponse.error.errornotes);
									}
									else
									{
										aHTML.push('Error: Cannot find contact | id: ' + oThisRow.id + '');
									}
									oParam.createAttendanceStep = 1;
									oParam.dataIndex += 1;
									aHTML.push('</td></tr>');
					...
					else if (oParam.createAttendanceStep == 3)
					{
						if (oThisRow.traineecontactbusiness && oThisRow.traineecontactperson && oThisRow['agritrainingcourseattendee.traineecontactbusiness.agrisubscription.id'])
						{
							var oLinkSearch = new AdvancedSearch();
							oLinkSearch.method = 'AGRI_TRAINEE_ATTENDANCE_LINK_SEARCH';
							oLinkSearch.addField('attendee,contactbusiness,contactperson,subscription');
							oLinkSearch.addFilter('attendee', 'EQUAL_TO', oThisRow.id);
							oLinkSearch.addFilter('contactbusiness', 'EQUAL_TO', oThisRow.traineecontactbusiness);
							oLinkSearch.addFilter('contactperson', 'EQUAL_TO', oThisRow.traineecontactperson);
							oLinkSearch.addFilter('subscription', 'EQUAL_TO', oThisRow['agritrainingcourseattendee.traineecontactbusiness.agrisubscription.id']);
							oLinkSearch.getResults(function(oResponse)
							{
								if (oResponse.status == 'OK')
								{
									oParam.createAttendanceStep = 1;
									if (oResponse.data.rows.length > 0)
									{	// Already exists - go to next row
										oParam.dataIndex += 1;
									}
									else
									{
										oParam.createAttendanceStep = (bPerformUpdate) ? 4 : 1;
										oParam.dataIndex += (bPerformUpdate) ? 0 : 1;
									}
								}
								else
								{
									aHTML.push('<tr><td>' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + ' | Error finding existing link  | id: ' + oThisRow.id + ': ' +
													oResponse.error.errornotes + '<br />');
									$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
									oParam.dataIndex += 1;
								}
								fFunctionUpdate(oParam);
						...
						else
						{
							oParam.createAttendanceStep = 1;
							oParam.dataIndex += 1;
							aHTML.push('<tr><td>' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + ' | Error: Still has blank ids  | id: ' + oThisRow.id);
							fFunctionUpdate(oParam);
						}
					}

					// Create the link
					else if (oParam.createAttendanceStep == 4)
					{
						oLinkData = 
						{	
							attendee: oThisRow.id,
							contactbusiness: oThisRow.traineecontactbusiness,
							contactperson: oThisRow.traineecontactperson,
							subscription: oThisRow['agritrainingcourseattendee.traineecontactbusiness.agrisubscription.id']
						};
						...
						$.ajax(
						{
							...
							success: function(oResponse)
							{
								...
								{
									aHTML.push('<tr><td>' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
												' | ' + oThisRow.traineecontactpersontext.formatXHTML() + '</td></tr>');
								}
								else
								{
									aHTML.push('<tr><td>' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
												' | ' + oResponse.error.errornotes +'</td></tr>');
								}
								$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
	...
	populateAuditQualifyingTrainee:
	{
		/* Create seQualifyingTraineeLink on Audit */
		setParams: function(oParam)
		{
			if (oParam === undefined) {oParam = {}}

			oParam.xhtmlContext = 'QualifyingTraining';
			oParam.title = 'Populate Qualifying Training on Audit';
			oParam.description = 'Initial population of Audit.seQualifyingTrainingLink';
			oParam.search = {};
			oParam.search.method = 'AUDIT_SEARCH';
			oParam.search.fields = 'contactbusiness,contactperson,contactbusinesstext,contactpersontext,actualdate,status,resultstatus,resultstatusdate,codeofpractice,' +
									'subscription,audit.agrisubscription.membership,audit.codeofpractice.copbasedtraining,sequalifyingtraininglink,resultstatustext,' +
									'codeofpracticetext,audit.agrisubscription.membership.code';
			iWineMemberships = $.map($.grep(nsFreshcare.data.memberships, function(x) {return x.code == 'VIT' || x.code == 'WIN'}),
										function(y) {return y.id}).join(',');
			oParam.search.filters = 
			[
				// Only Audits for default COP (but not Wine Industry) that aren't lapsed
				/*{field: 'sequalifyingtraininglink', comparison: 'IS_NULL'},
				{field: 'actualdate', comparison: 'GREATER_THAN_OR_EQUAL_TO', value1: '01 Jan 2016'},*/
				{field: 'audit.codeofpractice.membership', comparison: 'NOT_IN_LIST', value1: iWineMemberships},
				{field: 'audit.codeofpractice.isdefault', comparison: 'EQUAL_TO', value1: 'Y'},
				{field: 'membershipstatus', comparison: 'NOT_EQUAL_TO', value1: '-1'}
			];
			oParam.search.sortFields = 
			[
				{field: 'contactbusinesstext', direction: 'asc'},
				{field: 'actualdate', direction: 'asc'}
			];
			oParam.functionUpdate = nsFreshcare.setup.bulkupdate.populateAuditQualifyingTrainee.update;
		...
		update: function(oParam)
		{
			// Setup - search for list of Qualifying COP
			// Step 1 - For each row find training for same Business + Membership + Qualifying COP
			// Step 2 - Search to see if link exists already
			// Step 3 - create link if doesn't exist
			// Step 4 - update Audit with link ID
			oParam = oParam || {};
			var oData = ns1blankspace.util.getParam(oParam, 'data').value;
			var iRowCount = ns1blankspace.util.getParam(oParam, 'startRow', {'default': 0}).value;
			var iTotal = ns1blankspace.util.getParam(oParam, 'totalCount', {'default': 0}).value;
			...
			else
			{
				if (iDataIndex === -1 && oData.length > 0)
				{
					if (oParam.startRow === 1)
					{	$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('');	}
					nsFreshcare.setup.bulkupdate.data.auditData = oData;
					iDataIndex = 0;
					oParam.dataIndex = 0;
					oParam.updateStep = 1;

					// First, get list of QualifyingCOPs for each Membership/COP
					var oQualifyingSearch = new AdvancedSearch();
					oQualifyingSearch.method = 'AGRI_CODE_OF_PRACTICE_QUALIFYING_TRAINING_SEARCH';
					oQualifyingSearch.addField('codeofpractice,qualifyingcodeofpractice,qualifyingcodeofpracticetext,agriqualifyingtraining.qualifyingcodeofpractice.membership.code,' +
											'agriqualifyingtraining.codeofpractice.membership,agriqualifyingtraining.codeofpractice.membership.code');
					oQualifyingSearch.addFilter('agriqualifyingtraining.codeofpractice.copbasedtraining', 'EQUAL_TO', 'Y');
					oQualifyingSearch.sort('agriqualifyingtraining.codeofpractice.membership', 'asc');
					oQualifyingSearch.async = false;
					oQualifyingSearch.getResults(function(oResponse)
					{
						nsFreshcare.data.memberships = $.map(nsFreshcare.data.memberships, function(x) {x.qualifyingCOPs = []; return x;});

						if (oResponse.status == 'OK')
						{
							$.each(oResponse.data.rows, function(i, cop)
							{	
								var iMembershipIndex = $.grep($.map(nsFreshcare.data.memberships, function(y, index) {return {id: y.id, index: index}}),
															function(x) {return x.id == cop['agriqualifyingtraining.codeofpractice.membership']}).shift().index;
								nsFreshcare.data.memberships[iMembershipIndex].qualifyingCOPs.push(cop);
							});
						}
						else
						{
							aHTML.push('Error finding Qualifying COP\s: ' + oResponse.error.errornotes + '</td></tr>');
							$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
							bContinue = false;
						}
					});
				...
				if (bContinue && iDataIndex < nsFreshcare.setup.bulkupdate.data.auditData.length)
				{
					var oThisRow = nsFreshcare.setup.bulkupdate.data.auditData[iDataIndex];
					var sContactBusinessText = oThisRow['contactbusinesstext'].formatXHTML() + 
							' | ' + oThisRow.actualdate + (oThisRow.resultstatusdate != '' ? '|' + oThisRow.resultstatusdate : '') + ' | ' +
							oThisRow.resultstatustext +
							'|' + oThisRow['audit.agrisubscription.membership.code'] + ' ' + oThisRow.codeofpracticetext;
					var oThisMembership = $.grep(nsFreshcare.data.memberships, function(x) {return x.id == oThisRow['audit.agrisubscription.membership']}).shift();

					// Find training for same Business + Membership + Qualifying COP - Course must be correct status
					if (oParam.updateStep == 1)
					{
						oParam.updateStep = 2;
						var aQualifyingCOPs = (oThisRow['audit.codeofpractice.copbasedtraining'] == 'Y')
												? $.grep(oThisMembership.qualifyingCOPs, function(x) 
													{
														return x['agriqualifyingtraining.codeofpractice.membership'] == oThisRow['audit.agrisubscription.membership'] &&
																x.codeofpractice == oThisRow.codeofpractice;
													})
												: [];

						var oTrainingSearch = new AdvancedSearch();
						oTrainingSearch.method = 'AGRI_EDUCATION_TRAINING_COURSE_ATTENDEE_SEARCH';
						oTrainingSearch.addField('traineecontactbusiness,traineecontactperson,agritrainingcourseattendee.course.coursedate,' +
													'agritrainingcourseattendee.course.package.codeofpractice,agritrainingcourseattendee.course.package.membership');

						if (aQualifyingCOPs.length > 0)
						{
							oTrainingSearch.addFilter('agritrainingcourseattendee.course.package.codeofpractice', 'IN_LIST', $.map(aQualifyingCOPs, function(x) {return x.qualifyingcodeofpractice}).join(','));
						}
						else
						{
							oTrainingSearch.addFilter('agritrainingcourseattendee.course.package.membership', 'EQUAL_TO', oThisRow['audit.agrisubscription.membership'])
						}
						oTrainingSearch.addFilter('traineecontactbusiness', 'EQUAL_TO', oThisRow.contactbusiness);
						// If Cert Recommended, Course Status must be completed and dated priot to resultstatusdate
						if (oThisRow.resultStatus == nsFreshcare.data.audit.resultStatusCompleted)
						{
							oTrainingSearch.addFilter('agritrainingcourseattendee.course.status', 'EQUAL_TO', nsFreshcare.data.trainingCourse.statusCompleted);
							oTrainingSearch.addFilter('agritrainingcourseattendee.course.coursedate', 'LESS_THAN_OR_EQUAL_TO', oThisRow.resultstatusdate);
						}
						else
						{
							oTrainingSearch.addFilter('agritrainingcourseattendee.course.status', 'NOT_EQUAL_TO', nsFreshcare.data.trainingCourse.statusCancelled);
						}
						oTrainingSearch.sort('agritrainingcourseattendee.course.coursedate', 'desc');	// We want them to use the most recent qualifying course

						oTrainingSearch.getResults(function(oResponse)
						{
							aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText);
							if (oResponse.status == 'OK' && oResponse.data.rows.length > 0)
							{
								oParam.updateStep = 2;
								oThisRow.possibleAttendees = $.map(oResponse.data.rows, function(x) {return x.id}).join(',');
								oThisRow.traineecontactperson = oResponse.traineecontactperson;
								aHTML.push('| Qualifying training found | ' + oResponse.data.rows.length + ' attendances');
							}
							else
							{
								if (oResponse.status == 'ER')
								{
									aHTML.push(' | Error finding qualifying training | id: ' + oThisRow.id + ': ' + oResponse.error.errornotes);
								}
								else
								{
									aHTML.push(' | Error: No qualifying training found | id: ' + oThisRow.id + '');
								}
								oParam.updateStep = 1;
								oParam.dataIndex += 1;
							}
					...
					// Now look for a link record
					else if (oParam.updateStep == 2)
					{
						var oLinkSearch = new AdvancedSearch();
						oLinkSearch.method = 'AGRI_TRAINEE_ATTENDANCE_LINK_SEARCH';
						oLinkSearch.addField('attendee,contactbusiness,contactperson,subscription,agritraineeattendancelink.attendee.course.coursedate');
						oLinkSearch.addFilter('attendee', 'IN_LIST', oThisRow.possibleAttendees);
						oLinkSearch.addFilter('contactbusiness', 'EQUAL_TO', oThisRow.contactbusiness);
						oLinkSearch.addFilter('subscription', 'EQUAL_TO', oThisRow['subscription']);
						oLinkSearch.sort('agritraineeattendancelink.attendee.course.coursedate', 'desc');
						oLinkSearch.getResults(function(oResponse)
						{
							if (oResponse.status == 'OK')
							{
								if (oResponse.data.rows.length > 0)
								{	// Already exists - save link ID to audit
									oParam.updateStep = 4;
									oThisRow.attendanceLinkID = oResponse.data.rows[0].id;
								}
								else
								{	// Create the link
									oParam.updateStep = 3;
							...
							{
								aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
												' | Error finding existing link | id: ' + oThisRow.id + ': ' +
												oResponse.error.errornotes);
								$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
								oParam.dataIndex += 1;
								oParam.updateStep = 1;
						}
					...
					// Create the link
					else if (oParam.updateStep == 3)
					{
						oLinkData = 
						{	
							attendee: oThisRow.possibleAttendees.split(',').shift(),
							contactbusiness: oThisRow.contactbusiness,
							contactperson: oThisRow.traineecontactperson,
							subscription: oThisRow['subscription']
						};
						...
						if (bUpdate)
						{
							$.ajax(
							{
								...
								success: function(oResponse)
								{
									...
									{
										aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
													' | Attendee link added</td></tr>');
										oThisRow.attendanceLinkID = oResponse.id;
										oParam.updateStep = 4;
									}
									else
									{
										aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
													' | Error adding attendee link | id: ' + oThisRow.id + ': ' + oResponse.error.errornotes +'</td></tr>');
										oParam.dataIndex = iDataIndex + 1;
										oParam.updateStep = 1;
									}
									$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
						...
						{
							aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
										' | Attendee link to be added</td></tr>');
					...
					// Update audit.sequalifyingtrainglink with linkID
					else if (oParam.updateStep == 4)
					{
						oParam.dataIndex = iDataIndex + 1;
						oParam.updateStep = 1;
						if (bUpdate)
						{
							var oData = {id: oThisRow.id, sequalifyingtraininglink: oThisRow.attendanceLinkID};
							...
							$.ajax(
							{
								...
								success: function(oResponse)
								{
									...
									{
										aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
													' | Error setting seQualifyingTrainingLink | id: ' + oThisRow.id + ': ' + oResponse.error.errornotes +'</td></tr>');
									}
									fFunctionUpdate(oParam);
								}
							});
	...
	populateAuditRecertAuditMonth:
	{
		/* v3.3.001 Update seReCertAuditMonth on Audit */
		setParams: function(oParam)
		{
			if (oParam === undefined) {oParam = {}}

			oParam.xhtmlContext = 'AuditRecertAuditMonth';
			oParam.title = 'Populate Re-Cert Audit Month on Audit';
			oParam.description = 'Initial population of Audit.seReCertAuditMonth';
			oParam.search = {};
			oParam.search.method = 'AUDIT_SEARCH';
			oParam.search.fields = 'contactbusiness,contactperson,contactbusinesstext,contactpersontext,actualdate,status,resultstatus,resultstatusdate,codeofpractice,' +
									'subscription,audit.agrisubscription.membership,resultstatustext,audit.serecertauditmonth,' +
									'codeofpracticetext,audit.agrisubscription.membership.code,audit.agrisubscription.expirymonth';
			oParam.search.filters = 
			[
				// Only update IN/CE audits post 01 Jan 2017 as this was the date JASANZ was implemented
				{field: 'actualdate', comparison: 'GREATER_THAN_OR_EQUAL_TO', value1: '01 Jan 2017'},
				{field: 'membershipstatus', comparison: 'IN_LIST', value1: nsFreshcare.data.grower.subscriptionStatusCE + ',' + nsFreshcare.data.grower.subscriptionStatusIN},
				{field: 'audit.agrisubscription.expirymonth', comparison: 'IS_NOT_NULL'}
			];
			oParam.search.sortFields = 
			[
				{field: 'contactbusinesstext', direction: 'asc'},
			...
			oParam.functionUpdate = nsFreshcare.setup.bulkupdate.populateAuditRecertAuditMonth.update;
		...
		update: function(oParam)
		{
			// If not set, update audit.serecertauditmonth
			oParam = oParam || {};
			var oData = ns1blankspace.util.getParam(oParam, 'data').value;
			var iRowCount = ns1blankspace.util.getParam(oParam, 'startRow', {'default': 0}).value;
			var iTotal = ns1blankspace.util.getParam(oParam, 'totalCount', {'default': 0}).value;
			...
			else
			{
				...
				if (iDataIndex < nsFreshcare.setup.bulkupdate.data.auditData.length)
				{
					var oThisRow = nsFreshcare.setup.bulkupdate.data.auditData[iDataIndex];
					var sContactBusinessText = oThisRow['contactbusinesstext'].formatXHTML() + 
							' | ' + oThisRow.actualdate + '|' + oThisRow['audit.agrisubscription.expirymonth'];

					var oAuditData = 
					{	
						id: oThisRow.id,
						serecertauditmonth: oThisRow['audit.agrisubscription.expirymonth']
					};
					...
					if (bUpdate)
					{
						$.ajax(
						{
							...
							success: function(oResponse)
							{
								...
								{
									aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
												' | Error updating Audit | id: ' + oThisRow.id + ': ' + oResponse.error.errornotes +'</td></tr>');
								}
								$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
	...
	populateJASANZAuditFlag:
	{
		/* v3.3.001 Populate seJASANZAudit on Audit */
		setParams: function(oParam)
		{
			if (oParam === undefined) {oParam = {}}
			
			oParam.xhtmlContext = 'JASANZAuditFlag';
			oParam.title = 'Populate JASANZ Audit Flag Audit';
			oParam.description = 'Initial population of Audit.seJASANZAudit';
			oParam.search = {};
			oParam.search.method = 'AUDIT_SEARCH';
			oParam.search.fields = 'contactbusiness,contactbusinesstext,actualdate,audit.agrisubscription.membership.jasanzaccredited,' +
									'audit.auditbusiness.se' + nsFreshcare.data.jasanzDateId;
			
			oParam.search.filters = 
			[
				// Only filter is where seJASANZAudit is null as we want to update ALL audits. Actualdate filter is for lab
				{field: 'sejasanzaudit', comparison: 'IS_NULL'},
				{field: 'actualdate', comparison: 'IS_NOT_NULL'}
			]
			oParam.search.sortFields = 
			[
				{field: 'actualdate', direction: 'asc'},
			...
			oParam.functionUpdate = nsFreshcare.setup.bulkupdate.populateJASANZAuditFlag.update;
		...
		update: function(oParam)
		{
			// If not set, update audit.sejasanzaudit to Y of CertBody's JASANZ Date is on or before the audit date, otherwise set to N
			oParam = oParam || {};
			var oData = ns1blankspace.util.getParam(oParam, 'data').value;
			var iRowCount = ns1blankspace.util.getParam(oParam, 'startRow', {'default': 0}).value;
			var iTotal = ns1blankspace.util.getParam(oParam, 'totalCount', {'default': 0}).value;
			...
			else
			{
				...
				{
					$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('No Audits found');
				}
				...
				if (iDataIndex < nsFreshcare.setup.bulkupdate.data.auditData.length)
				{
					var oThisRow = nsFreshcare.setup.bulkupdate.data.auditData[iDataIndex];
					var sContactBusinessText = oThisRow['contactbusinesstext'].formatXHTML() + 
							' | JASANZ: ' + oThisRow['audit.auditbusiness.se' + nsFreshcare.data.jasanzDateId] + ' | Audit:' + oThisRow.actualdate;

					dToday = new Date();
					var dAudit = new Date(oThisRow.actualdate);
					var dJASANZ = (oThisRow['audit.auditbusiness.se' + nsFreshcare.data.jasanzDateId] != '') 
									? new Date(oThisRow['audit.auditbusiness.se' + nsFreshcare.data.jasanzDateId])
									: dToday;

					var oAuditData = 
					{	
						id: oThisRow.id,
						sejasanzaudit: ((dAudit >= dJASANZ) ? 'Y' : 'N')
					};
					...
					if (bUpdate)
					{
						$.ajax(
						{
							...
							success: function(oResponse)
							{
								...
								{
									aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
												' | JASANZ Audit flag set to ' + oAuditData.sejasanzaudit + '</td></tr>');
								}
								else
								{
									aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
					...
					{
						aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
									' | JASANZ Audit flag to be set to ' + oAuditData.sejasanzaudit + '</td></tr>');
	...
	populateLinkRequests:
	{
		/* v3.3.001 Update seallowlinkrequests on Business for Members */
		setParams: function(oParam)
		{
			if (oParam === undefined) {oParam = {}}
			
			oParam.xhtmlContext = 'LinkRequests';
			oParam.title = 'PopulateLink Requests flag on Members';
			oParam.description = 'Initial population of COntactBusiness.seallowlinkrequests';
			oParam.search = {};
			oParam.search.method = 'CONTACT_BUSINESS_SEARCH';
			oParam.search.fields = 'id,tradename,seallowlinkrequests,businessgroup';
			
			oParam.search.filters = 
			[
				// Only filter is where seallowlinkrequests is null as we want to update ALL Members.
				{field: 'seallowlinkrequests', comparison: 'IS_NULL'},
				{field: 'businessgroup', comparison: 'EQUAL_TO', value1: nsFreshcare.data.businessGroupGrowerID},
				{field: 'id', comparison: 'NOT_EQUAL_TO', value1: '1261016'}
			]
			oParam.search.sortFields = 
			[
				{field: 'tradename', direction: 'asc'}
			];
			oParam.functionUpdate = nsFreshcare.setup.bulkupdate.populateLinkRequests.update;
		...
		update: function(oParam)
		{
			...
			else
			{
				if (iDataIndex === -1 && oData.length > 0)
				{
					if (oParam.startRow === 1)
					{	$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('');	}
					nsFreshcare.setup.bulkupdate.data.memberData = oData;
					iDataIndex = 0;
					oParam.dataIndex = 0;
					oParam.updateStep = 1;
				}
				...
				if (iDataIndex < nsFreshcare.setup.bulkupdate.data.memberData.length)
				{
					var oThisRow = nsFreshcare.setup.bulkupdate.data.memberData[iDataIndex];
					var sContactBusinessText = oThisRow.tradename.formatXHTML();
					...
					if (bUpdate)
					{
						$.ajax(
						{
							...
							success: function(oResponse)
							{
								...
								{
									aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
												' | Allow Link Requests flag set to Y</td></tr>');
								}
								else
								{
									aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
												' | Error updating Member | id: ' + oThisRow.id + ': ' + oResponse.error.errornotes +'</td></tr>');
								}
								$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
					...
					{
						aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sContactBusinessText + 
									' | Allow Lin Requests flag to be set to Y</td></tr>');
	...
	populateCARTypePrefix:
	{
		...
		setParams: function(oParam)
		{
			...
			oParam.xhtmlContext = 'CARTypePrefix';
			oParam.title = 'PopulateLink CAR Type Prefix';
			oParam.description = 'Initial population of SINType.prefix';
			oParam.search = {};
			oParam.search.method = 'SETUP_AUDIT_ISSUE_SINTYPE_SEARCH';
			oParam.search.fields = 'id,code,prefix,membershiptext';
			
			oParam.search.filters = 
			[
				// Only filter is where prefix is null
				{field: 'prefix', comparison: 'IS_NULL'},
			]
			oParam.search.sortFields = 
			[
				{field: 'membershiptext', direction: 'asc'},
				{field: 'code', direction: 'asc'}
			];
			oParam.functionUpdate = nsFreshcare.setup.bulkupdate.populateCARTypePrefix.update;
		...
		update: function(oParam)
		{
			// Move single-character prefix from code to prefix field. Checks if first char is a letter
			oParam = oParam || {};
			var oData = ns1blankspace.util.getParam(oParam, 'data').value;
			var iRowCount = ns1blankspace.util.getParam(oParam, 'startRow', {'default': 0}).value;
			var iTotal = ns1blankspace.util.getParam(oParam, 'totalCount', {'default': 0}).value;
			...
			else
			{
				if (iDataIndex === -1 && oData.length > 0)
				{
					if (oParam.startRow === 1)
					{	$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('');	}
					nsFreshcare.setup.bulkupdate.data.sinTypeData = oData;
					iDataIndex = 0;
					oParam.dataIndex = 0;
					oParam.updateStep = 1;
				}
				...
				{
					$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('No CAR Types found');
				}

				if (iTotal > 500)		// We only show the progress count if we have over 500 records
				{
					$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressCountProgress').html(iDataIndex + oParam.startRow);
				}


				if (iDataIndex < nsFreshcare.setup.bulkupdate.data.sinTypeData.length)
				{
					var oThisRow = nsFreshcare.setup.bulkupdate.data.sinTypeData[iDataIndex];
					var sCARTypeText = oThisRow.membershiptext.formatXHTML() + ': ' + oThisRow.code.formatXHTML();
					var sFirstChar = oThisRow.code.formatXHTML().substr(0,1);
					var oPostData = {id: oThisRow.id};
					oParam.updateStep = 1;
					...
					if (isLetter(sFirstChar))
					{
						oPostData.prefix = sFirstChar;
						oPostData.code = oThisRow.code.substr(1);
						...
						if (bUpdate)
						{
							$.ajax(
							{
								...
								success: function(oResponse)
								{
									...
									if (oResponse.status === 'OK')
									{
										aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sCARTypeText + 
													' | Prefix set to ' + oPostData.prefix + '</td></tr>');
									}
									else
									{
										aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sCARTypeText + 
													' | Error updating Prefix | id: ' + oThisRow.id + ': ' + oResponse.error.errornotes +'</td></tr>');
									}
									$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
						...
						{
							aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sCARTypeText + 
										' | Prefix to be set to ' + oPostData.prefix + '</td></tr>');
					...
					{
						aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + ' | ' + sCARTypeText + 
									' | Prefix is not alpha - no update required</td></tr>');
	...
	populateActionBusiness:
	{
		/* v4.0.009 Update contactbusiness on emails  */
		setParams: function(oParam)
		{
			if (oParam === undefined) {oParam = {}}
			
			oParam.xhtmlContext = 'UpdateActionBusiness';
			oParam.title = 'Populate Action Business';
			oParam.description = 'Fix emails where contactbusiness not saved';
			oParam.search = {};
			oParam.search.method = 'ACTION_SEARCH';
			oParam.search.fields = 'id,contactperson,action.contactperson.contactbusiness,actiontype,contactpersontext,createddate';
			
			oParam.search.filters = 
			[
				// contactbusiness is null, contactperson has a contactbusiness, actiontype is email
				{field: 'contactbusiness', comparison: 'IS_NULL'},
				{field: 'action.contactperson.contactbusiness', comparison: 'IS_NOT_NULL'},
				{field: 'actiontype', comparison: 'IN_LIST', value1: '5,9,10,' + ns1blankspace.data.actionTypes.bulkEmail.id}
			]
			oParam.search.sortFields = 
			[
				{field: 'contactperson', direction: 'asc'},
				{field: 'createddate', direction: 'asc'}
			];
			oParam.functionUpdate = nsFreshcare.setup.bulkupdate.populateActionBusiness.update;
		...
		update: function(oParam)
		{
			// Update contactbusiness on actions with contactbusiness linked to person
			oParam = oParam || {};
			var oData = ns1blankspace.util.getParam(oParam, 'data').value;
			var iRowCount = ns1blankspace.util.getParam(oParam, 'startRow', {'default': 0}).value;
			var iTotal = ns1blankspace.util.getParam(oParam, 'totalCount', {'default': 0}).value;
			...
			var fFunctionUpdate = ns1blankspace.util.getParam(oParam, 'functionUpdate').value;
			var bUpdate = false;
			var sPrevPerson = ns1blankspace.util.getParam(oParam, 'previousPerson', {'default': ''}).value;
			oParam.processStep = oParam.processStep || 1;
			...
			else
			{
				if (iDataIndex === -1 && oData.length > 0)
				{
					if (oParam.startRow === 1)
					{	$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('');	}
					nsFreshcare.setup.bulkupdate.data.actionData = oData;
					iDataIndex = 0;
					oParam.dataIndex = 0;
					oParam.actionIDData = [];
				}
				...
				{
					$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('No Actions found');
				}
				...
				if (oParam.processStep == 1 && iDataIndex < nsFreshcare.setup.bulkupdate.data.actionData.length)
				{
					var oThisRow = nsFreshcare.setup.bulkupdate.data.actionData[iDataIndex];
					oParam.dataIndex = iDataIndex + 1;
					
					if (sPrevPerson == oThisRow.contactperson)
					{
						oParam.actionIDData.push(oThisRow.id);
					}
					else
					{
						oParam.actionIDData = [oThisRow.id];
					}
					oParam.contactBusiness = oThisRow['action.contactperson.contactbusiness'];
					if ((iDataIndex + 1) == nsFreshcare.setup.bulkupdate.data.actionData.length
						|| nsFreshcare.setup.bulkupdate.data.actionData[iDataIndex + 1].contactperson != sPrevPerson)
					{
						oParam.processStep = 2;
					}
					aHTML.push('<tr><td class="ns1blankspaceRow">' + oThisRow.contactpersontext + ': action dated ' + oThisRow.createddate + '</td></tr>');
					$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
					oParam.previousPerson = oThisRow.contactperson;
					fFunctionUpdate(oParam);
				}
				
				// Perform the update
				else if (oParam.processStep == 2)
				{
					var oPostData = {contactbusiness: oParam.contactBusiness, id: oParam.actionIDData.join(',')};
					oParam.processStep = 1;
					if (bUpdate)
					{
						$.ajax(
						{
							...
							success: function(oResponse)
							{
								if (oResponse.status === 'OK')
								{
									aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + 
												' | ContactBusiness set to ' + oParam.contactBusiness + ' for ' + oParam.actionIDData.length + ' rows</td></tr>');
								}
								else
								{
									aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) +
												' | Error setting ContactBusiness | id: ' + oParam.contactBusiness + ': ' + oResponse.error.errornotes +'</td></tr>');
								}
								$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
					...
					{
						aHTML.push('<tr><td class="ns1blankspaceRow">' + (iDataIndex + oParam.startRow) + 
									' | ContactBusiness to be set to ' + oParam.contactBusiness + ' for ' + oParam.actionIDData.length + ' rows</td></tr>');
	...
	removeInvalidScopes:
	{
		setParams: function(oParam)
		{
			...
			oParam.xhtmlContext = 'removeInvalidScopes';
			oParam.title = 'Remove Invalid Scopes';
			oParam.description = 'Remove invalid scopes from Subscription records';
			oParam.search = {};
			oParam.search.method = 'AGRI_MEMBERSHIP_SEARCH';
			oParam.search.fields = 'id,title';
			oParam.search.filters = [{field: 'status', comparison: 'EQUAL_TO', value1: '2'}]
			oParam.functionUpdate = nsFreshcare.setup.bulkupdate.removeInvalidScopes.update;
		...
		update: function(oParam)
		{
			// Remove invalid scopes from subscription records
			oParam = oParam || {};
			var oData = ns1blankspace.util.getParam(oParam, 'data').value;
			var iRowCount = ns1blankspace.util.getParam(oParam, 'startRow', {'default': 0}).value;
			var iTotal = ns1blankspace.util.getParam(oParam, 'totalCount', {'default': 0}).value;
			...
			else
			{
				if (iDataIndex === -1 && oData.length > 0)
				{
					if (oParam.startRow === 1)
					{	$('#ns1blankspaceBulkUpdate' + sXHTMLContext + 'ProgressBar').html('');	}
					nsFreshcare.setup.bulkupdate.data.memberships = oData;
					iDataIndex = 0;
					oParam.dataIndex = 0;
					oParam.actionIDData = [];
				}
				...
				if (oParam.processStep == 1 && iDataIndex < nsFreshcare.setup.bulkupdate.data.memberships.length)
				{
					var oThisRow = nsFreshcare.setup.bulkupdate.data.memberships[iDataIndex];
					oParam.dataIndex = iDataIndex + 1;
					
					oParam.membership = oThisRow['id'];
					aHTML.push('<tr><td class="ns1blankspaceRow">' + oThisRow.title + '</td></tr>');
					$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
					oParam.processStep = 2;
					fFunctionUpdate(oParam);
				}
				
				// Get subscription records with invalid scopes 
				else if (oParam.processStep == 2)
				{
					var oMembership = $.grep(nsFreshcare.data.memberships, function(x) {return x.id == oParam.membership}).shift();
					var oSearch = new AdvancedSearch();
					oSearch.method = 'AGRI_SUBSCRIPTION_SEARCH';
					oSearch.addField('id,contactbusinesstext,agrisubscription.agriobjectscope.scope,agrisubscription.agriobjectscope.id' +
								',agrisubscription.agriobjectscope.scopetext,membership,membershiptext,createddate');
					oSearch.addFilter('membership', 'EQUAL_TO', oParam.membership);
					oSearch.addFilter('agrisubscription.agriobjectscope.scope', 'NOT_IN_LIST', $.map(oMembership.validScopes, function(x) {return x.scope}).join(','));
					oSearch.sort('contactbusinesstext', 'asc');
					oSearch.rows = '2000';
					oSearch.getResults(function(oResponse)
					{
						...
						{
							oParam.processStep = 3;
							nsFreshcare.setup.bulkupdate.data.invalidScopes = oResponse.data.rows;
							fFunctionUpdate(oParam);
						}
					});
				}

				else if (oParam.processStep == 3)
				{
					var oPostData = {remove: "1"};
					var aUpdateIDs = [];
					oParam.updateTotal = oParam.updateTotal || nsFreshcare.setup.bulkupdate.data.invalidScopes.length;
					oParam.updatedCount = oParam.updatedCount || 0;

					for (var i = 0; i < (oParam.updateTotal > 200 ? 200 : oParam.updateTotal); i++)
					{
						aUpdateIDs.push(nsFreshcare.setup.bulkupdate.data.invalidScopes[oParam.updatedCount]['agrisubscription.agriobjectscope.id']);
						oParam.updatedCount++;
					}
					oPostData.id = aUpdateIDs.join(',');

					if (bUpdate && oPostData.id != '')
					{
						$.ajax(
						{
							type: 'POST',
							...
							success: function(oResponse)
							{
								if (oResponse.status === 'OK')
								{
									aHTML.push('<tr><td class="ns1blankspaceRow">' + aUpdateIDs.length + ' scopes removed</td></tr>');
								}
								else
								{
									aHTML.push('<tr><td class="ns1blankspaceRow">' + aUpdateIDs.length + ' scopes NOT removed</td></tr>');
								}
								$('#' + sProgressTableId).children().children().last().after(aHTML.join(''));
								
								if (oParam.updatedCount == oParam.updateTotal)
								{
									oParam.updateTotal = undefined;
									oParam.updatedCount = undefined;
									oParam.processStep = 1;
								}
								fFunctionUpdate(oParam);
							}
					...
					{
						aHTML.push('<tr><td class="ns1blankspaceRow">' + aUpdateIDs.length + ' scopes to be removed</td></tr>');
