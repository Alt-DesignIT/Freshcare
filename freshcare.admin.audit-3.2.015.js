...
nsFreshcare.admin.audit = 
{
	...
	show: 		function (oParam, oResponse)
	{
		...
		else if (oParam.showStep == 10)
		{
			...
			{
				var oRoot = ns1blankspace.rootnamespace;
				oRoot[nsFreshcare.user.roleID].grower.init({showHome: false});
				oRoot[nsFreshcare.user.roleID].grower.search.send('-' + $(this).attr('data-id'));
			});
				...
				[
					...
					{text: "Take me to the Membership and I'll update it now.", icons: {primary: 'ui-icon-close'}, 
						click: function() 
						{
							...
							nsFreshcare[nsFreshcare.user.roleID].grower.init({showHome: false, id: ns1blankspace.data.contactBusiness});
						}
					},
