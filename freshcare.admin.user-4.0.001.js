...
nsFreshcare.admin.user = 
{
			...
			else
			{
				...
				else
				{
					...
					aHTML.push('<div class="ns1blankspaceCaption"' +
									'style="padding-left:8px; margin-bottom:10px; font-weight:500;">MOST RECENTLY LOGGED ON</div>');
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						ns1blankspace.container.position({xhtmlElementID: 'ns1blankspaceUserNetworkGroupAdd', leftOffset: -252, topOffset: 0});
						$(ns1blankspace.xhtml.container).html(aHTML.join(''));
						$(ns1blankspace.xhtml.container).show(ns1blankspace.option.showSpeedOptions);
	...
	switchIn: 	function() 
	{
		...
		// v3.2.022 To stop errors when admin try to send out emails when switvhed in as an auditor
		nsFreshcare.data.emailFromAuditor = nsFreshcare.data.switched.email;	
	...
	switchOut: 	function() 
	{
		...
		nsFreshcare.data.emailFromAuditor = 'noreply@freshcare.com.au';		// v3.2.022 Reset this now that switched back
