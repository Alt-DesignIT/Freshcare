				...
				if (ns1blankspace.okToSave) 
				{
					if (oParam.step === 1) 
					{
						...
						if ($('#ns1blankspaceMainAddress').html() != '') 
						{
							...
							// v3.1.210 SUP023116 Now UPDATES business mailing address AND person mailingaddress. 
							// v3.1.210 SUP022943 Mailing Address is only set to updated if at least one field updated
							// v3.1.214 SUP023267 v3.1.213 had reverted back to pre-210
