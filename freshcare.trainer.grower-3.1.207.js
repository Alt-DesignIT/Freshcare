			...
			else if (oParam.step >= 1)
			{
				...
				else 	// A new trainee - add to AGRI_TEMP_TRAINEE
				{
					...
					else if (oParam.step === 10) 
					{
						...
						// 2.0.4j SUP021638  Moved message from within else below to outside
						ns1blankspace.container.confirm({title: '!', html: 'The new grower will appear on your training course once approved by Freshcare.'});
