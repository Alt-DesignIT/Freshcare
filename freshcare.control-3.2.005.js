	...
	invoice:
	{
		...
		{	/* v3.2.004 Added ItemSearch fields */
			return 'lineitem.financialaccount,lineitem.financialaccount.code,lineitem.financialaccounttext,lineitem.tax,lineitem.issuedamount' +
					...
					',lineitem.orderitem.order.reference,lineitem.orderitem.order';
		},
	}
};
...
[
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.grower-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.customer.grower-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.extend-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
