...
nsFreshcare.admin.newmemberships = 
{
		...
		else
		{
			...
			else
			{
				...
				aHTML.push('<div class="ns1blankspaceCaption"' +
								'style="padding-left:8px; margin-bottom:10px; font-weight:500;">NEW MEMBERSHIPS</div>');
	...
	summary: 	function ()
	{
		...
		else
		{
			...
			{
				// v3.2.015 SUP023422 Added COP Based Training
				aHTML.push('<tr><td class="ns1blankspaceSummaryCaption">' + nsFreshcare.data.growerText + ' Primary Contact</td></tr>' +
							'<tr><td class="ns1blankspaceSummary">' +
