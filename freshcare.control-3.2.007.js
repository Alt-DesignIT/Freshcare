...
ns1blankspace.option.preLoad = function()
{
	...
	ns1blankspace.scripts = 
		...
		{
			if (x.nameSpace === '1blankspace.supportIssue') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.supportissue-2.0.5.js';}
			if (x.nameSpace === '1blankspace.messaging.imap') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.messaging.imap-2.0.614.js';}
			if (x.nameSpace === '1blankspace.messaging.conversation') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.messaging.conversation-2.0.5.js';}
	...
	// v3.2.006 util.timezone not yet on prod server
	ns1blankspace.scripts = $.grep(ns1blankspace.scripts, function(x) {return x.nameSpace != '1blankspace.util.timezone'});
...
[
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.audit-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.grower-3.2.006.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.user-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.external.grower-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.extend',
		source: '/site/' + nsFreshcare.site + '/freshcare.extend-3.2.006.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.setup.freshcareprofile-3.2.005.js',
		sourceNS: nsFreshcare
	},
	{
