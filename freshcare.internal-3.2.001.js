...
nsFreshcare.internal = 
{
	...
	contactBusiness:
	{
			...
			[
				{
					tab: 'Summary',
					create: [],
					retrieve: [nsFreshcare.data.roles.admin, nsFreshcare.data.roles.internalAuditor, nsFreshcare.data.roles.xeroSuperUser],
					update: [],
					delete: [nsFreshcare.data.roles.admin]
				},
				{
					tab: 'Details', 
					create: [nsFreshcare.data.roles.admin, nsFreshcare.data.roles.internalAuditor],
					retrieve: [nsFreshcare.data.roles.admin, nsFreshcare.data.roles.internalAuditor, nsFreshcare.data.roles.xeroSuperUser],
					update: [nsFreshcare.data.roles.admin, nsFreshcare.data.roles.internalAuditor],
					delete: [nsFreshcare.data.roles.admin]
				},
				{
					tab: 'Address',
				...
				},
				{
					tab: 'Groups',
					create: [],
					retrieve: [nsFreshcare.data.roles.admin, nsFreshcare.data.roles.internalAuditor],
					update: [nsFreshcare.data.roles.admin, nsFreshcare.data.roles.internalAuditor],
					delete: [nsFreshcare.data.roles.admin]
				},
				{
				...
				},
				{
					tab: 'Xero',
					create: [],
					retrieve: [nsFreshcare.data.roles.admin, nsFreshcare.data.roles.xeroSuperUser],
					update: [nsFreshcare.data.roles.xeroSuperUser],
					delete: [nsFreshcare.data.roles.admin]
				},
				{
					tab: 'Emails',
			...
			send: function (sXHTMLElementId, oParam)
			{
				...
				{							
					...
					oSearch.addField( 'reference,tradename,legalname,phonenumber,faxnumber,industry,industrytext,' +
										...
										',webaddress,area,areatext,sexerocontactid,' +
		...
		layout: function()
		{
			...
			if (ns1blankspace.objectContext == -1)
			{
				if (nsFreshcare.internal.contactBusiness.roleHasAccess({action: 'add', tabs: ['Details', 'Address']}))
				{
			...
			else
			{
				...
				if (nsFreshcare.internal.contactBusiness.roleHasAccess({tabs: ['Groups', 'Relationships']}))
				{
				...
				aHTML.push('<table class="ns1blankspaceControl">');
				if (nsFreshcare.internal.contactBusiness.roleHasAccess({tabs: ['Financial']}))
				{
					aHTML.push('<tr><td id="ns1blankspaceControlFinancial" class="ns1blankspaceControl">Financials</td></tr>');
				}
				if (nsFreshcare.internal.contactBusiness.roleHasAccess({tabs: ['Xero']}))
				{
				...
				if (nsFreshcare.internal.contactBusiness.roleHasAccess({tabs: ['Emails', 'Actions', 'Attachments']}))
				{
