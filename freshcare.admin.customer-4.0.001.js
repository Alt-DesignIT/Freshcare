...
nsFreshcare.admin.customer = 
{
	...
	home: 		function (oParam, oResponse)
	{
		...
		if (oResponse == undefined)
		{
			...
			{
				$('#ns1blankspaceControl').html('<i style="color:#ccc; font-size:2em; margin-top:12px; margin-right:6px; margin-bottom:12px;" class="glyphicon glyphicon-folder-open"></i>');		
			}
			else
			{
	...
	layout: 	function ()
	{
		...
		$('#ns1blankspaceControlGroups').click(function(event)
		{
			...
			nsFreshcare.internal.entity.groups.show({contextGroup: 'Business'});
		});
