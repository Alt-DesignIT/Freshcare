...
nsFreshcare.admin.contactPerson = 
{
	data: 
	{
		...
		[
			...
			{name: 'surname', caption: 'Surname'},
			{name: 'titletext', caption: 'Title'},
			{name: 'position', caption: 'Postion'},
			{name: 'email', caption: 'Email'},
			{name: 'workphone', caption: 'Phone'},
			{name: 'mobile', caption: 'Mobile'},
			{name: 'fax', caption: 'Fax'},
			{name: 'customerstatustext', caption: 'Customer Status'},
			{name: 'supplierstatustext', caption: 'Supplier Status'},
			{name: 'sendnews', caption: 'Send News?'},
			{name: 'streetaddress1', caption: 'Street Address Line 1'},
			{name: 'streetaddress2', caption: 'Street Address Line 2'},
			{name: 'streetsuburb', caption: 'Street Suburb'},
			{name: 'streetpostcode', caption: 'Street Post Code'},
			{name: 'streetcountry', caption: 'Street Country'},
			{name: 'postaladdress1', caption: 'Postal Address Line 1'},
			{name: 'postaladdress2', caption: 'Postal Address Line 2'},
			{name: 'postalsuburb', caption: 'Postal Suburb'},
			{name: 'postalpostcode', caption: 'Postal Post Code'},
			{name: 'postalcountry', caption: 'Postal Country'},
			{name: 'dateofbirth', caption: 'Date of Birth'},
			{name: 'numberofchildren', caption: 'Number of Children'},
			{name: 'otherfamilydetails', caption: 'Other Family Details'},
			{name: 'contactbusinesstext', caption: 'Business'},
			{
				name: 'sexeropersonid', 
				caption: 'Xero Person ID', 
				include: function() {return nsFreshcare.option.exportToXero}
			},
			{
				name: 'sexeropersonupdated', 
	...
	actions: function()
	{
		...
		// v3.2.025 COnditional access to add actions
		...
		({
			...
			functionPostSave: nsFreshcare.admin.contactPerson.actions
		});
	}
};
...
nsFreshcare.admin.contactPerson.render =
{
	...
	search:
	{
		...
		rowParameters:
		{
			// v3.2.020 conditionally adds xero fields
	...
	[	/* v3.2.001 SUP023329 Now restricts access based on nsFreshcare.admin.contactPerson.access */
		{	/* Summary */
			...
			fields:
			[	// v3.2.025 Conditionally display Favourite options
				{
					name: "Business",
					label: "Business Name",
					type: ns1blankspace.option.typeReadOnly,
					displayColumn: 1,
					displayCondition: function() {return ns1blankspace.objectContextData.contactbusiness != ''},
				...
				},
				{
					...
					displayColumn: 2,
					displayCondition: function() {return !ns1blankspace.option.preventUpdates != true && nsFreshcare.admin.contactPerson.data.isFavourite},
		...
		{	/* Groups */
			...
			displayConditionParams: {tabs: ['Groups']},
		...
		{	/* Training */
			...
			label: 'Training',
			showOnNew: false,
			displayCondition: function() {return nsFreshcare.option.qualifyingTraining && nsFreshcare.admin.contactPerson.functionCheckAccess({tabs: ['Training']})},
			functionClick: function()
			{
		...
		{	/* Xero */
			...
			label: "Xero",
			showOnNew: false,
			displayCondition: function() {return nsFreshcare.option.exportToXero},	/* v3.2.020 Added */
			breakAfter: true,
			save: {root: true},
			functionClick: function(oParam)
			{
		...
		{	/* Actions */
			...
			functionClick: function()
			{
				// v3.4.001 Moved out to own function so that can re-call when done adding
				nsFreshcare.admin.contactPerson.actions();
			}
		},
		{	/* Emails */
			name: "Emails",
			...
			showOnNew: false,
			displayCondition: nsFreshcare.admin.contactPerson.functionCheckAccess,
			displayConditionParams: {tabs: ['Emails']},
			functionClick: function()
			{
				...
				// v3.4.007 Added bulkemail to actions filter
		...
		{	/* Attachments */
			// v3.2.025 Changed to Freshcare version and conditionally display Add button
			name: "Attachments",
			label: 'Attachments',
			showOnNew: false,
			displayCondition: nsFreshcare.admin.contactPerson.functionCheckAccess,
			displayConditionParams: {tabs: ['Attachments']},
			functionClick: function()
			{
