...
ns1blankspace.option.preLoad = function()
{
	...
	ns1blankspace.scripts = 
		$.map(ns1blankspace.scripts, function(x)
		{
			...
			if (x.nameSpace === '1blankspace.messaging.imap') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.messaging.imap-2.2.8.js';}
			...
			if (x.nameSpace === '1blankspace.action') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.action-3.0.8.js';}
			if (x.nameSpace === '1blankspace.contactPerson') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.contactperson-3.0.5.js';}
			if (x.nameSpace === '1blankspace.report') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.report-3.0.8.js';}		
			...
			if (x.nameSpace === '1blankspace.setup.financial') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.setup.financial-2.1.0.js';}	// v3.2.020
			if (x.nameSpace === '1blankspace.document') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.document-3.3.8.js';}	// v3.2.020
...
[
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.util-3.4.015.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.attendance',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.attendance-3.4.001.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.audit',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.audit-3.4.015.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.auditcar',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.auditcar-3.4.015.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.certificationbody',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.certificationbody-3.3.005.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.certificate',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.certificate-3.4.015.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.customer-3.3.001.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.grower',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.grower-3.4.010.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.newelearning-3.4.016.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.newgrower',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.newgrower-3.4.010.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.newtrainee-3.3.008.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.relationships',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.relationships-3.3.001.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.report',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.report-3.4.015.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.trainer',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.trainer-3.3.001.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.trainingpackage',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.trainingpackage-3.4.004.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.trainingcourse',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.trainingcourse-3.4.010.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.user',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.user-3.2.022.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.auditor.grower-3.4.010.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.auditor.home',
		source: '/site/' + nsFreshcare.site + '/freshcare.auditor.home-3.4.015.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.customer.grower-3.3.006.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.external.grower-3.4.010.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.extend',
		source: '/site/' + nsFreshcare.site + '/freshcare.extend-3.4.004.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.external.resources',
		source: '/site/' + nsFreshcare.site + '/freshcare.external.resources-3.4.001.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.grower.certificate-3.3.001.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.grower.grower-3.4.007.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.grower.home',
		source: '/site/' + nsFreshcare.site + '/freshcare.grower.home-3.3.001.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.internal-3.4.010.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.reviewer.home-3.2.025.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.setup.bulkupdate',
		source: '/site/' + nsFreshcare.site + '/freshcare.setup.bulkupdate-3.3.001.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.external.freshcareprofile',
		source: '/site/' + nsFreshcare.site + '/freshcare.setup.freshcareprofile-3.4.010.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.setup.membership',
		source: '/site/' + nsFreshcare.site + '/freshcare.setup.membership-3.4.015.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.setup.cartype',
		source: '/site/' + nsFreshcare.site + '/freshcare.setup.cartype-3.3.001.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.setup.schemecodes-3.3.001.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.trainer.grower-3.3.001.js',
		sourceNS: nsFreshcare
	},
	{
...
nsFreshcare.app = 
{
	...
	bindClasses: function()
	{
		...
		$('.nsFreshcareSelectable').live('click', function()
		{
		...
		$('.nsFreshcareHarvestMonthsSelected').live('click', function()
		{
			if ($(this).attr('data-1blankspace') != 'ignore')
			{
				ns1blankspace.inputDetected = true;
	...
	initCommonVariables: 	function() 
	{
		...
		if (nsFreshcare.sitesDev.indexOf(nsFreshcare.site) > -1) 
		{
			...
			nsFreshcare.data.documentCertificateBackground = '6366';		// v3.3.001
		...
		else 
		{
			...
			nsFreshcare.data.documentCertificateBackground = '114342';		
...
nsFreshcare.control = 
{
		...
		if (oParam.controlInitStep === 0) 
		{
			...
			if (ns1blankspace.user.roles) 
			{
				...
				else 
				{
					...
					{	
						nsFreshcare.supportAdmin = (ns1blankspace.user.logonName.split('@').shift() === 'ibcom' || ns1blankspace.rootnamespace.sitesDev.indexOf(oRoot.site) > -1);
					}
	...
	freshcareMemberships: 	function(oParam, oResponse) 
	{
		...
		if (oParam.freshcareMembershipsStep === 1) 
		{
			if (oResponse === undefined) 
			{
				...
				oSearch.addField('code,description,priorityorder,reference,status,statustext,title,jasanzaccredited');
	...
	getCertificationBodyOptions: function(oParam)
	{
		...
		else if (oParam.cbOptionsStep === 2)
		{
			...
			//oSearch.addFilter('trainercontactperson', 'IS_NULL');
			oSearch.getResults(function(oResponse)
			{
				if (oResponse.status == 'OK')
				{
					nsFreshcare.data.auditor.jasanzDates = oResponse.data.rows;
