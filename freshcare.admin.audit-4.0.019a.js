...
nsFreshcare.admin.audit = 
{
	...
	show: 		function (oParam, oResponse)
	{
		...
		// v4.0.019a SUP024339 Moved from step 3 to step 1
		...
		if ($('#ns1blankspaceMainDetails').attr('data-loading') == '1')
		{
			...
			if (ns1blankspace.objectContextData != undefined)
			{
				...
				if (nsFreshcare.user.roleID === nsFreshcare.data.roles.admin)
				{
					...
					// v4.0.019a SUP024339 Now only gets data if CB is blank or different
					if (ns1blankspace.objectContextData['audit.auditbusiness'] != '')
					{ 
						if (nsFreshcare.data.auditor == undefined
							|| (nsFreshcare.data.auditor.contactBusiness != ns1blankspace.objectContextData['audit.auditbusiness']))
						{
	...
	setJASANZAuditFlag: function(flagType)
	{
		...
		{
			if (nsFreshcare.data.auditor && Object.keys(nsFreshcare.data.auditor).length > 0
				&& nsFreshcare.data.auditor[flagType.toLowerCase() + 'Dates'] != undefined)
			{
