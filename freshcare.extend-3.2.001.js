				...
				show: function(oParam, oResponse)
				{
					...
					if (iStep == 1)
					{
						...
						else
						{
							if (oResponse == undefined && ns1blankspace.financial.data.accounts === undefined)
							{
								var oSearch = new AdvancedSearch();
								oSearch.method = 'SETUP_FINANCIAL_ACCOUNT_SEARCH';
								oSearch.addField('title,parentaccount,parentaccounttext,postable,type,code,sexeroaccountid');
								oSearch.rows = 200;
					...
					else if (iStep == 4)
					{
						...
						aHTML.push('<tr class="ns1blankspaceCaption">' +
										...
										'<tr class="ns1blankspace">' +
										'<td class="ns1blankspaceText">' +
										'<input id="ns1blankspaceFinancialAccountCode" class="ns1blankspaceText hasFinancialAccess">' +
										'</td></tr>');		
						...
						if ($.grep(ns1blankspace.user.roles, function(x) {return x.id == nsFreshcare.data.roles.xeroSuperUser}).length > 0)
						{
							aHTML.push('<td class="ns1blankspaceText">' +
										'<input class="ns1blankspaceText hasXeroAccess" id="ns1blankspaceFinancialAccountXeroID">');
						}
						else
						{
							aHTML.push('<td id="ns1blankspaceFinancialAccountXeroID" class="ns1blankspaceText">');
						}
						aHTML.push('</td></tr>');
						...
						.click(function() 
						{
							...
							oAdd =
							{
								...
								"sexeroaccountid": $('#ns1blankspaceFinancialAccountXeroID').val()
							};
							...
							if (bHasXeroAccess)
							{
								sData += '&sexeroaccountid=' + oAdd.sexeroaccountid;
							}	
						...
						if (sID != undefined)
						{
							var oSearch = new AdvancedSearch();
							oSearch.method = 'SETUP_FINANCIAL_ACCOUNT_SEARCH';
							oSearch.addField('title,description,parentaccount,parentaccounttext,postable,expensecostofsale,taxtype,code,sexeroaccountid');
					...
					else if (iStep == 5)
					{
						if (oResponse.data.rows.length != 0)
						{
							...
							if ($('#ns1blankspaceFinancialAccountXeroID').is('input'))
							{$('#ns1blankspaceFinancialAccountXeroID').val(oObjectContext.sexeroaccountid.formatXHTML());}
							else
							{$('#ns1blankspaceFinancialAccountXeroID').html(oObjectContext.sexeroaccountid.formatXHTML());}
