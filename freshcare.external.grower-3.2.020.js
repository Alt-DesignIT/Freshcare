		...
		if ($('#ns1blankspaceMainDetails').attr('data-loading') == '1')
		{
			...
			if(ns1blankspace.objectName == 'newelearning')
			{
				...
				aHTML.push('<tr class="ns1blankspaceCaption">' +
							...
							'<tr id="ns1blankspaceDetailsRowSeRegisterNewBusiness" class="ns1blankspace">' +
							'<td class="ns1blankspaceText">' +
							'<input type="radio" id="radioSeRegisterNewBusiness1" name="SeRegisterNewBusiness" data-text="Y" value="Y"/>Yes' +
								'&nbsp;&nbsp;&nbsp;<input type="radio" id="radioSeRegisterNewBusiness2" name="SeRegisterNewBusiness" data-text="N" value="N"/>No' +
							'</td></tr>');
				...
				aHTML.push('<tr class="ns1blankspaceCaption">' +
							...
							'<td class="ns1blankspaceText">' +
							'<input type="radio" id="radioSeExistingBusiness1" name="radioSeExistingBusiness" data-text="Y" value="Y"/>Yes' +
								'&nbsp;&nbsp;&nbsp;<input type="radio" id="radioSeExistingBusiness2" name="radioSeExistingBusiness" data-text="N" value="N"/>No' +
							'</td></tr>');
				...
				aHTML.push('<tr class="ns1blankspaceCaption">' +
							...
							'<td class="ns1blankspaceText">' +
							'<input id="ns1blankspaceDetailsSeCertificateNumberUpdate" class="ns1blankspaceText" data-mandatory="1" data-caption="Certificate Number">' +
							'</td></tr>');	
			}
			...
			if (ns1blankspace.objectContextData)
			{
				...
				if(ns1blankspace.objectName == 'newelearning')
				{
					...
					if(ns1blankspace.objectContextData["seexistingbusiness"] == 'Y')
					{
						$('[name="radioSeExistingBusiness"][value="Y"]').attr('checked', true);
						$('#ns1blankspaceDetailsSeExistingBusiness').html("Yes");
						
					}
					else
					{	
						ns1blankspace.objectContextData["seexistingbusiness"]="N";
						$('[name="radioSeExistingBusiness"][value="N"]').attr('checked', true);
						$('#ns1blankspaceDetailsSeExistingBusiness').html("No");
						
					}

					if(ns1blankspace.objectContextData["seregisternewbusiness"] == 'Y')
					{
						$('[name="SeRegisterNewBusiness"][value="Y"]').attr('checked', true);
						$('#ns1blankspaceDetailsSeRegisterNewBusiness').html('Yes');
					}
					else
					{	
						ns1blankspace.objectContextData["seregisternewbusiness"]="N";
						$('[name="SeRegisterNewBusiness"][value="N"]').attr('checked', true);
						$('#ns1blankspaceDetailsSeRegisterNewBusiness').html('No');
					}
				...
				if (nsFreshcare.user.roleID === nsFreshcare.data.roles.admin)
				{
					...
					var createddate = ns1blankspace.objectContextData.createddate.substr(0, ns1blankspace.objectContextData.createddate.length - 8);
