		...
		else
		{
			...
			else
			{
				...
				$.each(oResponse.data.rows, function() {
					...
					var bShowCert = !(this['agricertificate.subscription.status'] === nsFreshcare.data.grower.subscriptionStatusWD || this['agricertificate.subscription.status'] === nsFreshcare.data.grower.subscriptionStatusFM);
