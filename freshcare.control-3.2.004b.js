...
ns1blankspace.option.preLoad = function()
{
	...
	ns1blankspace.scripts = 
		...
		{
			if (x.nameSpace === '1blankspace.supportIssue') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.supportissue-2.0.3.js';}
			...
			if (x.nameSpace === '1blankspace.order') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.order-2.0.3.js';}
			if (x.nameSpace === '1blankspace.product') {x.source = '/site/' + nsFreshcare.site + '/1blankspace.product-2.0.2.js';}
...
[
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.audit-3.1.215.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.certificate-3.1.215.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.contactPerson',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.contactperson-3.2.001.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.customer',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.customer-3.1.2.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.grower',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.grower-3.2.001.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.relationships-3.1.1i.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.trainingcourse-3.2.002.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.admin.user',
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.user-3.2.002.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.customer.grower-3.1.215.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.external.grower-3.1.213.js',
		sourceNS: nsFreshcare
	},
	{
		nameSpace: 'freshcare.extend',
		source: '/site/' + nsFreshcare.site + '/freshcare.extend-3.2.004.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.grower.customer-2.0.4.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.internal-3.2.004a.js',
		sourceNS: nsFreshcare
	},
	{
...
nsFreshcare.doLast = function() 
{
	...
	ns1blankspace.supportIssue.data.labelType1 = 'Bug Report';
	ns1blankspace.supportIssue.data.labelType2 = 'New Feature';
...
{	// Added v3.1.0 SUP022122
	...
	$('#ns1blankspaceLogonChangePasswordStatus').html('Password needs to be at least 6 characters and contain at least 1 number');
