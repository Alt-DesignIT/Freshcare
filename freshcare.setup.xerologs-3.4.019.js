 ...
 */
 ...
 // v3.4.019 SUP023960 Changed actionType rootnamspace to be interchangeable for Freshmark use
	...
	xerologs:
	{
		...
		home: 		function (oParam, oResponse)
		{
			if (oResponse == undefined)
			{
				...
				oSearch.addFilter('actiontype', 'EQUAL_TO', ns1blankspace.rootnamespace.data.actionTypeLogFile)
