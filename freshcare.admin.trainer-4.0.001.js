...
nsFreshcare.admin.trainer = 
{
	...
	search: 	
	{
		send: 		function (sXHTMLElementId, oParam)
		{
			...
			var iRows = 40;
			var fFunctionShow = ns1blankspace.util.getParam(oParam, 'functionShow', {'default': nsFreshcare.admin.trainer.show}).value;
	...
	accreditation: 	function(oParam) 
	{
		...
		else if (oParam.accreditationStep === 3) 
		{
			...
			// v4.0.001 Was displaying this on Trainer's Freshcareprofile and it's not valid
	...
	courses: 
	{
		show: function(oParam)
		{
			...
			else
			{
				...
				$('#ns1blankspaceTrainerCourseAdd')
					...
					.click(function() 
					{
						nsFreshcare.admin.trainer.addTrainingCourse({xhtmlElementID: this.id});
					});
		...
		row: function(oRow)
		{
			...
			aHTML.push('<td id="ns1blankspaceTrainerCourses_select-' + oRow.id + '"' +
	...
	addTrainingCourse: function(oParam)
	{
		...
		sXHTMLElementID = ns1blankspace.util.getParam(oParam, 'xhtmlElementID', {'default': 'ns1blankspaceTrainerAddCourse', set: true}).value;
