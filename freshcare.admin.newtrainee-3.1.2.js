...
nsFreshcare.admin.newtrainee = 
{
				...
				if (oResponse.status == 'OK')
				{
					...
					$('.nsFreshcareCreateLink')
						...
						.on('click', function()
						{
							var oData = 
							{
								id: $(this).attr('data-traineeid'),
								traineecontactperson: $(this).attr('data-contactId'),
								firstname: $(this).attr('data-contactfirstname'),
								surname: $(this).attr('data-contactsurname')
							}
		...
		send: 		function (sXHTMLElementId, oParam)
		{
			...
			if (sSearchContext != undefined && iSource != ns1blankspace.data.searchSource.browse)
			{
				...
				oSearch.addField('agritrainingcourseattendee.course.coursedate,agritrainingcourseattendee.course.trainercontactbusinesstext,traineecontactbusinesstext,course,traineecontactbusiness,' +
							...
							',agritrainingcourseattendee.course.title,phone,mobile,email,createddate,createduser,createdusertext,modifieddate,modifieduser,modifiedusertext');
	...
	summary: 	function ()
	{
		...
		else
		{
			...
			aHTML.push('<tr><td class="ns1blankspaceSummaryCaption">Grower Contact</td></tr>' +
						'<tr><td class="ns1blankspaceSummary">' +
