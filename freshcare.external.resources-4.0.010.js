...
nsFreshcare.external.resources = 
{
	...
	search: function(oParam) 
	{
		...
		oSearch.rows = 200;
		oSearch.sort(sSortColumn, sSortDirection);		// v4.0.010 SUP024128 Changed from title
	...
	show: 	function(oParam, oResponse)
	{
		...
		if ($('#' + sXHTMLElementID).attr('data-loading') == '1') 
		{
			...
			// v4.0.001 Bootstrap
			aHTML = [];
			aHTML.push('<span id="ns1blankspaceHomeResourcesSearchHandle" style="height:25px" title="Search Criteria"></span>');
		...
		if (oResponse) 
		{
			...
			else
			{
				...
				// v4.0.010 SUP024128 Added in header sorting
				aHTML.push('<tr class="ns1blankspaceCaption">');
				aHTML.push('<td class="ns1blankspaceHeaderCaption ns1blankspaceHeaderSort"' +
								' data-column="document.title"' +
								' data-sortdirection="' + ((sSortColumn == "document.title") ? ((sSortDirection === 'asc') ? "desc" : "asc") : 'asc') + '"' + 
							'>Title</td>');
				
				aHTML.push('<td class="ns1blankspaceHeaderCaption ns1blankspaceHeaderSort"' +
								' data-column="document.summary"' +
								' data-sortdirection="' + ((sSortColumn == "document.summary") ? ((sSortDirection === 'asc') ? "desc" : "asc") : 'asc') + '"' + 
							'>Summary</td>');
				aHTML.push('<td class="ns1blankspaceHeaderCaption ns1blankspaceHeaderSort"' +
								' data-column="document.modifieddate"' +
								' data-sortdirection="' + ((sSortColumn == "document.modifieddate") ? ((sSortDirection === 'asc') ? "desc" : "asc") : 'asc') + '"' + 
							'>Last Updated</td>');
				...
				ns1blankspace.render.page.show(
				{
					...
					functionOnNewPage: nsFreshcare.external.resources.rowBind,
					type: 'json'
				}); 	
