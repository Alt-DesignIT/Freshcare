		...
		fees: 
		{
			...
			details: function(oParam)
			{
				...
				aHTML.push('<tr class="ns1blankspaceCaption">' +
								...
								'<tr class="ns1blankspace">' +
								'<td class="ns1blankspaceText">' +
									'<input type="radio" id="radioFeeType1" name="radioFeeType" value="1"/>' +
										'Certification Body Royalty Rate<br />' +
									'<input type="radio" id="radioFeeType2" name="radioFeeType" value="2"/>' +
										'Certification Renewal Fee<br />' +
									'<input type="radio" id="radioFeeType3" name="radioFeeType" value="3"/>' +
										'Secondary Membership Fee<br />' +
									'<input type="radio" id="radioFeeType4" name="radioFeeType" value="4"/>' +
										'Trainer Royalty Rate' +
								'</td></tr>');			
			...
			send: function(oParam)
			{
				...
				else if (oParam.membershipSaveStep === 2)
				{
					sData += 'id=' + ((ns1blankspace.objectContext != -1) ? ns1blankspace.objectContext : '') +
							...
							'&title=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsTitle').val().formatXHTML()) +
							'&priorityorder=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsPriorityOrder').val().formatXHTML()) +
							'&status=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsStatus').attr('data-id')) +
							'&amount=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsCertFeeInitial').val().formatXHTML()) +
							'&renewalamount=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsCertFeeRenewal').val().formatXHTML()) +
							'&secondarymembershipfee=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsSecondaryCertFee').val().formatXHTML()) +
							'&trainerroyaltyrate=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsTrainerRoyalty').val().formatXHTML()) +
							'&certificationroyaltyrate=' + ns1blankspace.util.fs($('#ns1blankspaceDetailsAuditorRoyalty').val().formatXHTML()) +
					...
					$.ajax(
					{
						...
						success: function(oResponse)
						{
							...
							if (oResponse.status === 'OK')
							{
								...
								ns1blankspace.status.message('Membership added.');
							...
							{
								ns1blankspace.status.error('Membership not added: ' + oResponse.error.errornotes);
							}
						}
					});
				}
