		...
		codeOfPractice: 
		{
			search: function(oParam)
			{
				...
				oSearch.addField('agricodeofpractice.code,agricodeofpractice.description,agricodeofpractice.certificatetext,agricodeofpractice.isdefault,' +
									'agricodeofpractice.certificateexpiresafter,agricodeofpractice.auditdueafter,agricodeofpractice.membership,agricodeofpractice.displayorder,agricodeofpractice.COPBasedTraining');
			...
			show: function(oParam)
			{
				...
				else
				{
					...
					aHTML.push('<tr><td class="ns1blankspaceHeaderCaption">Code</td>' + 
							        ...
							        '<td class="ns1blankspaceHeaderCaption">COP Based Training</td>' + 
			...
			details: function(oParam)
			{
				...
				{	
					...
					nsFreshcare.setup.membership.codeOfPractice.searchQualifyingtraining(oThisCOP.id);
				}
				else 
				{
					// Set defaults
				...
				$('.ns1blankspaceQualifyingTrainingRemove').live('click', function (event) {		
					...
					nsFreshcare.setup.membership.codeOfPractice.removeQualifyingtraining(dataid);
				});
			},

			addQualifyingtraining: function(oParam)
			{
				// v3.2.020 SUP023422 Added COP Based Training
				var oData = 
						{
			...
			removeQualifyingtraining: function(CopId)
			{
				// v3.2.020 SUP023422 Added COP Based Training
				var oData =
				{
			...
			searchQualifyingtraining: function(CopId)
			{
				// v3.2.020 SUP023422 Added COP Based Training
				var aHTML = [];
				var oSearch = new AdvancedSearch();
				...
				send: function(oParam)
				{
					...
					else if (oParam.copSaveStep === 2)
					{
						...
						sData += 'id=' + ns1blankspace.util.fs($('#ns1blankspaceMembershipCOPId').html()) +
								...
								'&COPBasedTraining=' + ns1blankspace.util.fs($('input[name="COPBasedTraining"]:checked').val()) +
