...
[
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.admin.grower-3.1.215.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.extend-3.1.215.js',
		sourceNS: nsFreshcare
	},
	{
	...
	},
	{
		...
		source: '/site/' + nsFreshcare.site + '/freshcare.internal-3.1.215.js',
		sourceNS: nsFreshcare
	},
	{
	...
	init: 		function(oParam) 
	{
		...
		if (oParam.controlInitStep === 0) 
		{
			...
			if (ns1blankspace.user.roles) 
			{
				...
				if (aRoles.length > 1 && $.grep(aRoles, function(x) {return x.toLowerCase() == 'admin'}).length == 0) 
				{
