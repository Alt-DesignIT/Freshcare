...
nsFreshcare.external.grower = 
{
	details: 	function ()
	{
		...
		if ($('#ns1blankspaceMainDetails').attr('data-loading') == '1')
		{
			...
			if ((nsFreshcare.user.roleID === nsFreshcare.data.roles.trainer && ns1blankspace.objectContext === -1) 
				|| (nsFreshcare.user.roleID === nsFreshcare.data.roles.admin && ns1blankspace.objectContext != -1))
			{
				...
				aHTML.push('<tr class="ns1blankspaceCaption">' +
							...
							'<input id="ns1blankspaceDetailsTrainingCourseUpdate" class="ns1blankspaceSelect"' +
								...
								' data-parent="ns1blankspaceDetails' + ((nsFreshcare.user.roleID === nsFreshcare.data.roles.trainer) ? 'TrainingPackage' : 'Membership') + 'Update"' +
								' data-parent-search-id="agritrainingcourse.package' + ((nsFreshcare.user.roleID === nsFreshcare.data.roles.trainer) ? '' : 'membership') + '"' +
			...
			if (ns1blankspace.objectContext != -1 && nsFreshcare.user.roleID === nsFreshcare.data.roles.auditor) 
			{
				aHTML.push('<tr class="ns1blankspaceCaption">' +
								'<td class="ns1blankspaceCaption">' +
								'&nbsp;' +
			...
			if ((ns1blankspace.objectContext === -1 && nsFreshcare.user.roleID === nsFreshcare.data.roles.trainer)
				|| (nsFreshcare.user.roleID === nsFreshcare.data.roles.admin && ns1blankspace.objectContext != -1))
			{
				aHTML.push('<tr class="ns1blankspace ns1blankspaceHideOnNew">' +
								'<td class="ns1blankspaceCaption">' +
			...
			else if (ns1blankspace.objectContext === -1 && nsFreshcare.user.roleID === nsFreshcare.data.roles.trainer) {
			...
			if (ns1blankspace.objectContextData)
			{
				...
				if (nsFreshcare.user.roleID === nsFreshcare.data.roles.admin && $('#ns1blankspaceDetailsTrainingCourseUpdate').is('*'))
				{
			...
			if ((ns1blankspace.objectContext === -1 && nsFreshcare.user.roleID === nsFreshcare.data.roles.trainer)
				|| (ns1blankspace.objectContext != -1 && nsFreshcare.user.roleID === nsFreshcare.data.roles.admin))
			{
				if (nsFreshcare.user.roleID === nsFreshcare.data.roles.trainer
			...
			if ($('#ns1blankspaceMainContacts').attr('data-loading') == '1')
			{
				...
				else 
				{
					...
					{	
						...
						if (nsFreshcare.user.roleID === nsFreshcare.data.roles.trainer && ns1blankspace.objectName != nsFreshcare.data.roles.grower)
						{
