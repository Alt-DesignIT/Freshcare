...
nsFreshcare.admin.newgrower = 
{
	...
	search: 	
	{
		send: 		function (sXHTMLElementId, oParam)
		{
			...
			var oRoot = ns1blankspace.rootnamespace;
			var oNewGrowerRoot = (oRoot.admin && oRoot.admin.newgrower) ? oRoot.admin.newgrower : nsFreshcare.admin.newgrower;
			var sFields = 'abn,address1,address2,businessname,auditcontactbusiness,auditcontactbusinesstext,agritemptrainee.course.coursedate' +
							...
							',agritemptrainee.course.trainercontactbusiness,agritemptrainee.course.trainercontactbusinesstext,agritemptrainee.course.trainercontactperson' +
							',agritemptrainee.course.trainercontactpersontext,agritemptrainee.course.package.codeofpractice,agritemptrainee.course.package.codeofpracticetext' +
