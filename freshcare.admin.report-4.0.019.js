	...
	initData: function(oParam)
	{
		...
		if (ns1blankspace.report.dictionary === undefined || ns1blankspace.report.dictionary.length == 0)
		{
			...
			[
				...
				{name: 'audit.seioasaudit', caption: 'IOAS Audit?'},
	...
	initUnsentCertificatesReport: function(oParam)
	{
		...
		if ($.grep(ns1blankspace.report.reports, function(x) {return x.name === 'Unsent Mailed Certificates'}).length === 0)
		{
			ns1blankspace.report.reports.push(
				{
					...
					fixedParameters:
					{
						...
						[
							...
							{
								name: "agricertificate.audit.action.description.ioasAccredited", 
								exportHeader: "IOAS Accredited", 
								headerOnly: true,
								processFunction: nsFreshcare.admin.certificate.report.extractCertificateData,
								processParameter: {name: 'ioasAccredited'}
							}
						],
						filters:
						[
			...
			(
				...
				{name: "agricertificate.audit.action.description.ioasAccredited", caption: 'IOAS Certificate?'},
	...
	initCertificateDataReport: function(oParam)
	{
		...
		if ($.grep(ns1blankspace.report.reports, function(x) {return x.name === 'Certificate Data Report'}).length === 0)
		{
			ns1blankspace.report.reports.push(
				{
					...
					fixedParameters:
					{
						...
						[
							...
							{
								name: "audit.action.description.ioasAccredited", 
								exportHeader: "IOAS Accredited", 
								headerOnly: true,
								processFunction: nsFreshcare.admin.certificate.report.extractCertificateData,
								processParameter: {name: 'ioasAccredited'}
			...
			(
				...
				{name: "audit.action.description.ioasAccredited", caption: 'IOAS Certificate?'},
					...
					[
						{
							...
							[
								...
								{
									calculate: function(x) {
										 return nsFreshcare.admin.certificate.report.extractCertificateData(x, {name: "ioasAccredited"});
									}
								},
								{value: '"'}
							]
